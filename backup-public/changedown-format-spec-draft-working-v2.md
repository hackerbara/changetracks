...
This version focuses on stable core semantics: inline changes, identity, footnote structure, anchoring, projection semantics, coherence, and stewardship. Range operations can return in a follow-up revision once parser and conversion behavior are locked with explicit conformance tests.[^cn-27][^cn-5][^cn-6][^cn-6][^cn-7][^cn-21.2]
---
...
{~~{~~{~~: @alice | 2024-03-01 | move | rejected
    note: Move intro from section 3 to section 1
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Inherited stale proposal from copied source; not part of current working edits."

: @alice | 2024-03-01 | del | rejected
    3:b2 The intro paragraph here.
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Inherited stale proposal from copied source; not part of current working edits." (cascaded from cn-5)

: @alice | 2024-03-01 | ins | rejected
    12:f1 The intro paragraph here.
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Inherited stale proposal from copied source; not part of current working edits." (cascaded from cn-5)
```~>: @alice | 2024-03-01 | move | proposed
    note: Move intro from section 3 to section 1

: @alice | 2024-03-01 | del | proposed
    3:b2 The intro paragraph here.

: @alice | 2024-03-01 | ins | proposed
    12:f1 The intro paragraph here.
```~~}[^cn-41.1]~>: @alice | 2024-03-01 | move | proposed
    note: Move intro from section 3 to section 1
...
[^cn-17.2]: @alice | 2024-03-01 | ins | proposed
    12:f1 The intro paragraph here.
```~~}[^cn-40.1][^cn-5][^cn-5.1][^cn-5.2]

Accept the parent resolves all children. Reject a child carves out one exception. A change may carry multiple footnote references: `{~~slow~>fast~~}[^cn-1]` signals that cn-2 supersedes cn-1.[^cn-2]~>[^cn-17]: @alice | 2024-03-01 | move | proposed
    note: Move intro from section 3 to section 1
...
Accepting the parent resolves all still-proposed children. Rejecting a child carves out one exception. Use `supersedes: cn-1` in `cn-2` when the newer change explicitly replaces earlier intent.~~}[^cn-42]~>: @alice | 2024-03-01 | move | proposed
    note: Move intro from section 3 to section 1
...
The spec defines canonical producer output. Parsers should prefer compatibility over brittleness for reasonable variations.[^cn-28][^cn-20]
...
```
    revisions:
        r1 @alice 2024-01-18: Softened wording per feedback
            previous: reliable[^cn-43]
        r2 @alice 2024-01-20: Expanded scope
            previous: production-ready[^cn-44]
```
...
The body now reads `GraphQL` as clean text. The edit-op line (`4:e2 should use REST for the public`) remains as the coherence verification record.[^cn-40.3][^cn-39][^cn-35][^cn-34]
...
`Protocol ` is the context before. `o` is the operation. `verview` is the context after. The combined string appears exactly once on line 3 — any parser can recover the operation's exact column position.[^cn-36]
...
For deletions (where the deleted text is absent from the body), the context is the text surrounding the deletion point: `contextBeforetextcontextAfter`. The joined context locates where the deletion occurred.[^cn-37]
...
| Rejected | Body remains clean with rejection applied | Keep edit-op line    |[^cn-29]
...
A concise L2 snapshot: decided changes remain verifiable via edit-op records, while one proposed change keeps deliberation open inline.[^cn-31.1]
...
[^cn-3]: @carol | 2024-01-17 | highlight | accepted
    @carol 2024-01-17 [issue/blocking]: 100/min feels low for production.
      @alice 2024-01-18: Depends on infrastructure costs.
      @dave 2024-01-19 [todo]: I can run load tests next week.
    approved: @ai:gpt-5.3-codex 2026-04-02T03:56:13Z "Approved per request to accept all proposals."
    open -- awaiting load test results from @dave
```
...
The proposed highlight (`cn-3`) keeps deliberation open with a blocking issue and unresolved thread state.[^cn-40.6][^cn-3]

---

## References[^cn-31.2][^cn-19]
...
[^cn-25.1]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    ...
    approved: @ai:gpt-5.3-codex 2026-04-02T03:43:07Z "Future-first canonical projection terminology should be adopted in this draft."
...
[^cn-25.2]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    ...
    approved: @ai:gpt-5.3-codex 2026-04-02T03:43:07Z "Cascade terminology should align with canonical projection vocabulary."
...
[^cn-25.3]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    ...
    approved: @ai:gpt-5.3-codex 2026-04-02T03:43:07Z "Current projection wording is more accurate than accepted-all shorthand."
...
[^cn-25.4]: @ai:claude-opus-4.6 | 2026-04-02 | sub | accepted
    ...
    approved: @ai:gpt-5.3-codex 2026-04-02T03:43:07Z "Stewardship section should use canonical projection terms consistently."

[^cn-25]: @ai:claude-opus-4.6 | 2026-04-02 | group | proposed
    @ai:claude-opus-4.6 2026-04-02T00:14:40Z: propose_batch

[^cn-26]: @ai:gpt-5.3-codex | 2026-04-02 | del | rejected
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:43:07Z "Stray empty deletion artifact from earlier editing; no semantic value."

[^cn-27]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:43:27Z: Shorten and defer range syntax per your direction, reducing speculative surface area in the public spec.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Defer range changes section to keep this draft focused on stable implemented semantics."

[^cn-28]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:43:35Z: Adopt your preferred less-strict parser posture while keeping canonical output language explicit.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Use canonical-output plus compatibility-friendly parser philosophy wording."

[^cn-29]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:43:45Z: Adopt the future-first fully materialized demotion model in normative spec text.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Set fully materialized demotion semantics as future-first canonical behavior."

[^cn-30]: @ai:gpt-5.3-codex | 2026-04-02 | del | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:43:57Z: Remove legacy-domain mention from this public draft per your request.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Remove legacy-domain mention from this public-facing draft per product direction."

[^cn-31.1]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:44:08Z: Shorten the lead-in and state the core instructional purpose in one sentence.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Shorten complete-example intro while preserving educational purpose."

[^cn-31.2]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:44:08Z: Reduce repetitive narrative after the example while preserving interpretive guidance.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:44:48Z "Keep the shorter explanatory close after the complete example for clarity and brevity."

[^cn-31]: @ai:gpt-5.3-codex | 2026-04-02 | group | proposed
    @ai:gpt-5.3-codex 2026-04-02T03:44:08Z: propose_batch

[^cn-32]: @ai:gpt-5.3-codex | 2026-04-02 | sub | rejected
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Auto-generated overlap artifact from example text rewrite; reject to keep example stable."

[^cn-33]: @ai:gpt-5.3-codex | 2026-04-02 | hig | rejected
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:44:27Z "Auto-generated orphan highlight artifact; reject for a clean editorial state."

[^cn-34]: @ai:gpt-5.3-codex | 2026-04-02 | sub | rejected
    @ai:gpt-5.3-codex 2026-04-02T03:45:39Z: Avoid overloaded projection term 'settled' in lifecycle prose.}
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:45:43Z "Substitution overlapped embedded CriticMarkup literal in example prose; reject to avoid malformed mixed delimiter text."

[^cn-35]: @ai:gpt-5.3-codex | 2026-04-02 | sub | rejected
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:46:08Z "Malformed parser artifact from mixed delimiters in explanatory sentence."

[^cn-36]: @ai:gpt-5.3-codex | 2026-04-02 | sub | rejected
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:46:08Z "Parser artifact introduced while touching CriticMarkup-heavy prose."

[^cn-37]: @ai:gpt-5.3-codex | 2026-04-02 | del | rejected
    rejected: @ai:gpt-5.3-codex 2026-04-02T03:46:08Z "Parser artifact introduced while touching CriticMarkup-heavy prose."

[^cn-39]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:46:35Z: Replace malformed mixed CriticMarkup sentence with clean canonical prose.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:46:50Z "Finalize cleanup of malformed sentence into concise canonical wording."

[^cn-40.1]: @ai:gpt-5.3-codex | 2026-04-02 | sub | proposed
    @ai:gpt-5.3-codex 2026-04-02T03:49:45Z: Restore this example to neutral proposed-state semantics and remove inherited rejection artifacts from prior review cleanup.}

[^cn-40.3]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:49:45Z: Shorten lifecycle prose and remove unnecessary phrasing.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:56:13Z "Approved per request to accept all proposals."

[^cn-40.4]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:49:45Z: Align conversion step wording with canonical Current semantics (not naive accept-all wording).}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:56:13Z "Approved per request to accept all proposals."

[^cn-40.5]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:49:45Z: Use canonical projection vocabulary consistently (`decided` over `settled`).}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:56:13Z "Approved per request to accept all proposals."

[^cn-40.6]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:49:45Z: Repair corrupted paragraph and keep the example explanation concise and explicit.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:56:13Z "Approved per request to accept all proposals."

[^cn-40]: @ai:gpt-5.3-codex | 2026-04-02 | group | proposed
    @ai:gpt-5.3-codex 2026-04-02T03:49:45Z: propose_batch

[^cn-41.1]: @ai:gpt-5.3-codex | 2026-04-02 | sub | proposed
    @ai:gpt-5.3-codex 2026-04-02T03:50:28Z: Clean the grouped example by removing inherited rejection-history noise; keep it as a neutral proposed example.}

[^cn-41]: @ai:gpt-5.3-codex | 2026-04-02 | group | proposed
    @ai:gpt-5.3-codex 2026-04-02T03:50:28Z: propose_batch

[^cn-42]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    @ai:gpt-5.3-codex 2026-04-02T03:50:44Z: Reset the grouped-change example to a clean canonical form after nested-artifact corruption.}
    approved: @ai:gpt-5.3-codex 2026-04-02T03:56:13Z "Approved per request to accept all proposals."

[^cn-43]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    approved: @ai:gpt-5.3-codex 2026-04-02T03:56:13Z "Approved per request to accept all proposals."

[^cn-44]: @ai:gpt-5.3-codex | 2026-04-02 | sub | accepted
    approved: @ai:gpt-5.3-codex 2026-04-02T03:56:13Z "Approved per request to accept all proposals."