...
That is why ChangeDown and the CriticMarkup open standard took a different approach. Every edit is  inline, attributed to its author, with a reason attached.
...
2. **Parser interprets intent** –  The CriticMarkup parser processes the request and identifies the appropriate editing action from the agent instructions through three stages:
   1. **Change Detection:** – supporting thousands of  editing sessions
...
|     | **Step**              | **Traditional process**                                        | **With ChangeDown integration integration**                                                                    |
| --- | --------------------- | -------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
