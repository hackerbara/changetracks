...
- **DOCX preview** — Import and export tracked markdown as Word documents. Footnote metadata preserved as Word comments[^ct-1.1].
...
- **Multi-editor** — Neovim (conceal/match architecture investigated), Sublime Text, web-based editors via LSP over WebSocket.[^ct-4]
...
[^ct-4]: @ai:claude-opus-4.6 | 2026-03-13 | del | rejected
...
[^ct-5]: @human:hackerbara | 2026-03-13 | sub | proposed
