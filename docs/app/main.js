...
`)}function Hc(e,t){return e.replace(Fa(),(e,n)=>t.some(e=>n>=e.start&&n<e.end)?e:``)}function Uc(e){let{bodyLines:t}=Wa(e.split(`
`));return t.join(`
`)+`
`}function Wc(e,t){let n=[...t].sort((e,t)=>t.range.start-e.range.start);for(let t of n)if(t.anchored!==!1)switch(t.type){case q.Insertion:e=e.slice(0,t.range.start)+e.slice(t.range.end);break;case q.Deletion:t.originalText&&(e=e.slice(0,t.range.start)+t.originalText+e.slice(t.range.start));break;case q.Substitution:t.originalText&&(e=e.slice(0,t.range.start)+t.originalText+e.slice(t.range.end));break}return e}function Gc(e){let t=zc(e).getChanges().filter(e=>e.status===J.Proposed),{bodyLines:n}=Wa(e.split(`
`)),r=n.join(`
`);return t.length>0&&(r=Wc(r,t)),r+`
`}function Kc(e,t){if(Va(e))return Uc(e);let n=zc(e,{skipCodeBlocks:t?.skipCodeBlocks??!1}).getChanges();if(n.length===0){let t=Oa(e);return Hc(Vc(e,t),t)}let r=[...n].sort((e,t)=>t.range.start-e.range.start).map(Bc),i=e;for(let e of r)i=i.slice(0,e.offset)+e.newText+i.slice(e.offset+e.length);let a=Oa(i);return i=Vc(i,a),i=Hc(i,a),i}function qc(e,t){if(Va(e))return Gc(e);let n=zc(e,{skipCodeBlocks:t?.skipCodeBlocks??!1}).getChanges();if(n.length===0){let t=Oa(e);return Hc(Vc(e,t),t)}let r=[...n].sort((e,t)=>t.range.start-e.range.start).map(js),i=e;for(let e of r)i=i.slice(0,e.offset)+e.newText+i.slice(e.offset+e.length);let a=Oa(i);return i=Vc(i,a),i=Hc(i,a),i}function Jc(e,t){for(let n of t)if(e>=n.start&&e<n.end)return n}function Yc(e,t,n){let r=[],i=[],a=0,o=[];for(let t=0;t<e.length;t++)e[t]===`
...
`}return t+=`  </div>
`,t}function Al(e){if(!e)return``;if(e.type===`resolved`){let t=`  <div class="cn-fn-resolution cn-resolved">`;return t+=`<span class="cn-fn-resolution-icon">&#x2714;</span> resolved `,t+=`<span class="cn-fn-author">${X(e.author)}</span> `,t+=`<span class="cn-fn-date">${X(e.date)}</span>`,e.reason&&(t+=`: ${X(e.reason)}`),t+=`</div>
...
`,t}function jl(e){return X(e)}function Ml(e,t,n,r){if(!r)return e;let i=t.metadata?.author;if(!i)return e;let a=r.getColor(i),o=n.isDarkTheme?a.dark:a.light;return e.replace(/^(<\w+)/,`$1 style="color: ${jl(o)}"`)}function Nl(e,t){if(t===`badge`)return``;let n=e.metadata;if(!n)return``;if(t===`summary`){let t=[];n.author&&t.push(`<span class="cn-anchor-author">${X(n.author)}</span>`);let r=wl(e.status),i=e.status.toLowerCase();return t.push(`<span class="cn-anchor-status ${jl(r)}">${X(i)}</span>`),`<span class="cn-anchor-meta">${t.join(` `)}</span>`}if(t===`projected`){let t=[];n.author&&t.push(`<span class="cn-anchor-author">${X(n.author)}</span>`),n.date&&t.push(`<span class="cn-anchor-date">${X(n.date)}</span>`);let r=wl(e.status),i=e.status.toLowerCase();t.push(`<span class="cn-anchor-status ${jl(r)}">${X(i)}</span>`),n.comment&&t.push(`<span class="cn-anchor-comment">${X(n.comment)}</span>`);let a=n.approvals?.length??0,o=n.rejections?.length??0;if(a>0||o>0){let e=``;a>0&&(e+=`&#x2714;${a}`),o>0&&(e+=` &#x2718;${o}`),t.push(`<span class="cn-anchor-approvals">${e.trim()}</span>`)}return`<span class="cn-anchor-meta cn-anchor-projected">${t.join(` `)}</span>`}return``}function Pl(e,t,n,r,i){let a=wl(e.status),o=Tl(e),s=` data-cn-pair="cn-pair-${e.range.start}"`;if(e.moveRole===`from`){let i=t.slice(e.contentRange.start,e.contentRange.end),c=r.find(t=>t.groupId===e.groupId&&t.moveRole===`to`)?.id??``,l=c?` <a class="cn-move-label" href="#cn-fn-ref-${jl(c)}" title="moved to ${jl(c)}">&#x2192; moved</a>`:` <span class="cn-move-label">&#x2192; moved</span>`,u=Nl(e,n.metadataDetail);return{start:e.range.start,end:e.range.end,html:`<del class="cn-move-from ${a}"${s}>${X(i)}</del>${o}${u}${l}`}}if(e.moveRole===`to`){let c=t.slice(e.contentRange.start,e.contentRange.end),l=r.find(t=>t.groupId===e.groupId&&t.moveRole===`from`)?.id??``,u=l?`<a class="cn-move-label" href="#cn-fn-ref-${jl(l)}" title="moved from ${jl(l)}">&#x2190; moved here</a> `:`<span class="cn-move-label">&#x2190; moved here</span> `,d=Nl(e,n.metadataDetail),f=Ml(`<ins class="cn-move-to ${a}"${s}>${Sl(c)}</ins>`,e,n,i);return{start:e.range.start,end:e.range.end,html:`${u}${f}${o}${d}`}}switch(e.type){case q.Insertion:{let r=e.modifiedText??t.slice(e.contentRange.start,e.contentRange.end),c=Nl(e,n.metadataDetail),l=Ml(`<ins class="cn-ins ${a}"${s}>${Sl(r)}</ins>`,e,n,i);return{start:e.range.start,end:e.range.end,html:`${l}${o}${c}`}}case q.Deletion:{let r=e.originalText??t.slice(e.contentRange.start,e.contentRange.end),i=Nl(e,n.metadataDetail);return{start:e.range.start,end:e.range.end,html:`<del class="cn-del ${a}"${s}>${Sl(r)}</del>${o}${i}`}}case q.Substitution:{let t=e.originalText??``,r=e.modifiedText??``,c=Nl(e,n.metadataDetail),l=Ml(`<ins class="cn-sub-ins ${a}">${Sl(r)}</ins>`,e,n,i);return{start:e.range.start,end:e.range.end,html:`<del class="cn-sub-del ${a}"${s}>${Sl(t)}</del>${l}${o}${c}`}}case q.Highlight:{let r=e.originalText??t.slice(e.contentRange.start,e.contentRange.end),i=Nl(e,n.metadataDetail),a=`<mark class="cn-hl"${s}>${Sl(r)}</mark>`;return{start:e.range.start,end:e.range.end,html:`${a}${o}${i}`}}case q.Comment:{if(!n.showComments)return{start:e.range.start,end:e.range.end,html:``};let i=e.metadata?.comment??t.slice(e.contentRange.start,e.contentRange.end),a=Nl(e,n.metadataDetail),c=s,l=r.indexOf(e),u=l>0?r[l-1]:void 0;return u&&u.type===q.Highlight&&e.range.start===u.range.end&&(c=` data-cn-pair="cn-pair-${u.range.start}"`),{start:e.range.start,end:e.range.end,html:`<span class="cn-comment"${c} title="${X(i)}">&#x1F4AC;</span>${o}${a}`}}default:return null}}function Fl(e){let t=[],n=/\[\^(cn-\d+(?:\.\d+)?)\]/g,r;for(;(r=n.exec(e))!==null;){let n=e.slice(r.index+r[0].length),i=e.slice(0,r.index).lastIndexOf(`
`)+1;if(r.index===i&&n.startsWith(`:`))continue;let a=r[1];t.push({start:r.index,end:r.index+r[0].length,html:`<sup class="cn-ref" id="cn-fn-ref-${X(a)}" data-cn-id="${X(a)}"><a href="#cn-fn-def-${X(a)}">${X(a)}</a></sup>`})}return t}function Il(e){return`  <span class="cn-ref-badge">${X(e)}</span> <a class="cn-fn-backlink" href="#cn-fn-ref-${X(e)}" title="Back to change">&#x21A9;</a>`}function Ll(e,t,n,r){let i=[],a=/^(\[\^(cn-\d+(?:\.\d+)?)\]:[ \t]*)(.*)/gm,o,s=[],c=r??Oa(e);for(;(o=a.exec(e))!==null;){if(Cl(o.index,o.index+o[0].length,c))continue;let t=o[2],n=o[3],r=o.index,i=r+o[0].length,a=e.slice(i).search(/\n\s*\n|\n\[\^cn-/);a>=0?i+=a:i=e.length,s.push({start:r,end:i,id:t,firstLine:n})}if(s.length===0)return[];let l=s[0].start,u=s[s.length-1].end;if(!n.showFootnotes)return[{start:l,end:u,html:``}];let d=`<section class="cn-footnotes">
...
`):(d+=`<div class="cn-footnote" id="cn-fn-def-${X(e.id)}" data-cn-id="${X(e.id)}">\n`,d+=Il(e.id),r?.author&&(d+=` <span class="cn-fn-author">${X(r.author)}</span>`),r?.date&&(d+=` <span class="cn-fn-date">${X(r.date)}</span>`),r?.status&&(d+=` <span class="cn-fn-status cn-${X(r.status)}">${X(r.status)}</span>`),r?.comment&&(d+=`\n  <div class="cn-fn-comment">${X(r.comment)}</div>`),d+=`
...
`).length,r=t.querySelector(`[data-source-line="${n}"]`);r&&r.scrollIntoView({behavior:`smooth`,block:`center`})}scrollToChangeId(e){let t=this.container;return t?this.viewportService.scrollToChangeId(t,e):!1}};Qe();function fm(){Bt(()=>{let e=G.value;if(!e)return;let t=e.replace(/\.md$/,``),n=e===Gt?`/`:t;window.location.pathname!==n&&window.history.pushState({contentPath:e},``,n),document.title=`${e.split(`/`).pop()?.replace(/\.md$/,``)||`Changedown`} — Changedown`}),z(()=>{let e=e=>{let t=e.state?.contentPath;t&&Wo.exists(t).then(e=>{e&&(G.value=t)})};return window.addEventListener(`popstate`,e),()=>window.removeEventListener(`popstate`,e)},[])}var pm=c({Children:()=>Km,Component:()=>y,Fragment:()=>v,PureComponent:()=>xm,StrictMode:()=>v,Suspense:()=>Em,SuspenseList:()=>km,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:()=>ch,cloneElement:()=>zm,createContext:()=>ce,createElement:()=>h,createFactory:()=>Fm,createPortal:()=>Mm,createRef:()=>_,default:()=>ph,findDOMNode:()=>Vm,flushSync:()=>dh,forwardRef:()=>Cm,hydrate:()=>Pm,isElement:()=>fh,isFragment:()=>Lm,isMemo:()=>Rm,isValidElement:()=>Im,lazy:()=>Om,memo:()=>Sm,render:()=>Nm,startTransition:()=>vm,unmountComponentAtNode:()=>Bm,unstable_batchedUpdates:()=>uh,useCallback:()=>H,useContext:()=>ke,useDebugValue:()=>Ae,useDeferredValue:()=>ym,useEffect:()=>z,useErrorBoundary:()=>je,useId:()=>Me,useImperativeHandle:()=>Oe,useInsertionEffect:()=>Hm,useLayoutEffect:()=>De,useMemo:()=>V,useReducer:()=>Ee,useRef:()=>B,useState:()=>R,useSyncExternalStore:()=>gm,useTransition:()=>bm,version:()=>lh});function mm(e,t){for(var n in t)e[n]=t[n];return e}function hm(e,t){for(var n in e)if(n!==`__source`&&!(n in t))return!0;for(var r in t)if(r!==`__source`&&e[r]!==t[r])return!0;return!1}function gm(e,t){var n=t(),r=R({t:{__:n,u:t}}),i=r[0].t,a=r[1];return De(function(){i.__=n,i.u=t,_m(i)&&a({t:i})},[e,n,t]),z(function(){return _m(i)&&a({t:i}),e(function(){_m(i)&&a({t:i})})},[e]),n}function _m(e){try{return!((t=e.__)===(n=e.u())&&(t!==0||1/t==1/n)||t!=t&&n!=n)}catch{return!0}var t,n}function vm(e){e()}function ym(e){return e}function bm(){return[!1,vm]}function xm(e,t){this.props=e,this.context=t}function Sm(e,t){function n(e){var n=this.props.ref;return n!=e.ref&&n&&(typeof n==`function`?n(null):n.current=null),t?!t(this.props,e)||n!=e.ref:hm(this.props,e)}function r(t){return this.shouldComponentUpdate=n,h(e,t)}return r.displayName=`Memo(`+(e.displayName||e.name)+`)`,r.__f=r.prototype.isReactComponent=!0,r.type=e,r}function Cm(e){function t(t){var n=mm({},t);return delete n.ref,e(n,t.ref||null)}return t.$$typeof=Wm,t.render=e,t.prototype.isReactComponent=t.__f=!0,t.displayName=`ForwardRef(`+(e.displayName||e.name)+`)`,t}function wm(e,t,n){return e&&(e.__c&&e.__c.__H&&(e.__c.__H.__.forEach(function(e){typeof e.__c==`function`&&e.__c()}),e.__c.__H=null),(e=mm({},e)).__c!=null&&(e.__c.__P===n&&(e.__c.__P=t),e.__c.__e=!0,e.__c=null),e.__k=e.__k&&e.__k.map(function(e){return wm(e,t,n)})),e}function Tm(e,t,n){return e&&n&&(e.__v=null,e.__k=e.__k&&e.__k.map(function(e){return Tm(e,t,n)}),e.__c&&e.__c.__P===t&&(e.__e&&n.appendChild(e.__e),e.__c.__e=!0,e.__c.__P=n)),e}function Em(){this.__u=0,this.o=null,this.__b=null}function Dm(e){var t=e.__&&e.__.__c;return t&&t.__a&&t.__a(e)}function Om(e){var t,n,r,i=null;function a(a){if(t||(t=e()).then(function(e){e&&(i=e.default||e),r=!0},function(e){n=e,r=!0}),n)throw n;if(!r)throw t;return i?h(i,a):null}return a.displayName=`Lazy`,a.__f=!0,a}function km(){this.i=null,this.l=null}function Am(e){return this.getChildContext=function(){return e.context},e.children}function jm(e){var t=this,n=e.h;if(t.componentWillUnmount=function(){F(null,t.v),t.v=null,t.h=null},t.h&&t.h!==n&&t.componentWillUnmount(),!t.v){for(var r=t.__v;r!==null&&!r.__m&&r.__!==null;)r=r.__;t.h=n,t.v={nodeType:1,parentNode:n,childNodes:[],__k:{__m:r.__m},contains:function(){return!0},namespaceURI:n.namespaceURI,insertBefore:function(e,n){this.childNodes.push(e),t.h.insertBefore(e,n)},removeChild:function(e){this.childNodes.splice(this.childNodes.indexOf(e)>>>1,1),t.h.removeChild(e)}}}F(h(Am,{context:t.context},e.__v),t.v)}function Mm(e,t){var n=h(jm,{__v:e,h:t});return n.containerInfo=t,n}function Nm(e,t,n){return t.__k??(t.textContent=``),F(e,t),typeof n==`function`&&n(),e?e.__c:null}function Pm(e,t,n){return oe(e,t),typeof n==`function`&&n(),e?e.__c:null}function Fm(e){return h.bind(null,e)}function Im(e){return!!e&&e.$$typeof===Xm}function Lm(e){return Im(e)&&e.type===v}function Rm(e){return!!e&&typeof e.displayName==`string`&&e.displayName.indexOf(`Memo(`)==0}function zm(e){return Im(e)?se.apply(null,arguments):e}function Bm(e){return!!e.__k&&(F(null,e),!0)}function Vm(e){return e&&(e.base||e.nodeType===1&&e)||null}var Hm,Um,Wm,Gm,Km,qm,Jm,Ym,Xm,Zm,Qm,$m,eh,th,nh,rh,ih,ah,oh,sh,ch,lh,uh,dh,fh,ph,Z=o((()=>{we(),Qe(),Qe(),Hm=De,(xm.prototype=new y).isPureReactComponent=!0,xm.prototype.shouldComponentUpdate=function(e,t){return hm(this.props,e)||hm(this.state,t)},Um=L.__b,L.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),Um&&Um(e)},Wm=typeof Symbol<`u`&&Symbol.for&&Symbol.for(`react.forward_ref`)||3911,Gm=function(e,t){return e==null?null:O(O(e).map(t))},Km={map:Gm,forEach:Gm,count:function(e){return e?O(e).length:0},only:function(e){var t=O(e);if(t.length!==1)throw`Children.only`;return t[0]},toArray:O},qm=L.__e,L.__e=function(e,t,n,r){if(e.then){for(var i,a=t;a=a.__;)if((i=a.__c)&&i.__c)return t.__e??(t.__e=n.__e,t.__k=n.__k),i.__c(e,t)}qm(e,t,n,r)},Jm=L.unmount,L.unmount=function(e){var t=e.__c;t&&(t.__z=!0),t&&t.__R&&t.__R(),t&&32&e.__u&&(e.type=null),Jm&&Jm(e)},(Em.prototype=new y).__c=function(e,t){var n=t.__c,r=this;r.o??=[],r.o.push(n);var i=Dm(r.__v),a=!1,o=function(){a||r.__z||(a=!0,n.__R=null,i?i(c):c())};n.__R=o;var s=n.__P;n.__P=null;var c=function(){if(!--r.__u){if(r.state.__a){var e=r.state.__a;r.__v.__k[0]=Tm(e,e.__c.__P,e.__c.__O)}var t;for(r.setState({__a:r.__b=null});t=r.o.pop();)t.__P=s,t.forceUpdate()}};r.__u++||32&t.__u||r.setState({__a:r.__b=r.__v.__k[0]}),e.then(o,o)},Em.prototype.componentWillUnmount=function(){this.o=[]},Em.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var n=document.createElement(`div`),r=this.__v.__k[0].__c;this.__v.__k[0]=wm(this.__b,n,r.__O=r.__P)}this.__b=null}var i=t.__a&&h(v,null,e.fallback);return i&&(i.__u&=-33),[h(v,null,t.__a?null:e.children),i]},Ym=function(e,t,n){if(++n[1]===n[0]&&e.l.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!==`t`||!e.l.size))for(n=e.i;n;){for(;n.length>3;)n.pop()();if(n[1]<n[0])break;e.i=n=n[2]}},(km.prototype=new y).__a=function(e){var t=this,n=Dm(t.__v),r=t.l.get(e);return r[0]++,function(i){var a=function(){t.props.revealOrder?(r.push(i),Ym(t,e,r)):i()};n?n(a):a()}},km.prototype.render=function(e){this.i=null,this.l=new Map;var t=O(e.children);e.revealOrder&&e.revealOrder[0]===`b`&&t.reverse();for(var n=t.length;n--;)this.l.set(t[n],this.i=[1,0,this.i]);return e.children},km.prototype.componentDidUpdate=km.prototype.componentDidMount=function(){var e=this;this.l.forEach(function(t,n){Ym(e,n,t)})},Xm=typeof Symbol<`u`&&Symbol.for&&Symbol.for(`react.element`)||60103,Zm=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Qm=/^on(Ani|Tra|Tou|BeforeInp|Compo)/,$m=/[A-Z0-9]/g,eh=typeof document<`u`,th=function(e){return(typeof Symbol<`u`&&typeof Symbol()==`symbol`?/fil|che|rad/:/fil|che|ra/).test(e)},y.prototype.isReactComponent=!0,[`componentWillMount`,`componentWillReceiveProps`,`componentWillUpdate`].forEach(function(e){Object.defineProperty(y.prototype,e,{configurable:!0,get:function(){return this[`UNSAFE_`+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})}),nh=L.event,L.event=function(e){return nh&&(e=nh(e)),e.persist=function(){},e.isPropagationStopped=function(){return this.cancelBubble},e.isDefaultPrevented=function(){return this.defaultPrevented},e.nativeEvent=e},ih={configurable:!0,get:function(){return this.class}},ah=L.vnode,L.vnode=function(e){typeof e.type==`string`&&function(e){var t=e.props,n=e.type,r={},i=n.indexOf(`-`)==-1;for(var a in t){var o=t[a];if(!(a===`value`&&`defaultValue`in t&&o==null||eh&&a===`children`&&n===`noscript`||a===`class`||a===`className`)){var s=a.toLowerCase();a===`defaultValue`&&`value`in t&&t.value==null?a=`value`:a===`download`&&!0===o?o=``:s===`translate`&&o===`no`?o=!1:s[0]===`o`&&s[1]===`n`?s===`ondoubleclick`?a=`ondblclick`:s!==`onchange`||n!==`input`&&n!==`textarea`||th(t.type)?s===`onfocus`?a=`onfocusin`:s===`onblur`?a=`onfocusout`:Qm.test(a)&&(a=s):s=a=`oninput`:i&&Zm.test(a)?a=a.replace($m,`-$&`).toLowerCase():o===null&&(o=void 0),s===`oninput`&&r[a=s]&&(a=`oninputCapture`),r[a]=o}}n==`select`&&(r.multiple&&Array.isArray(r.value)&&(r.value=O(t.children).forEach(function(e){e.props.selected=r.value.indexOf(e.props.value)!=-1})),r.defaultValue!=null&&(r.value=O(t.children).forEach(function(e){e.props.selected=r.multiple?r.defaultValue.indexOf(e.props.value)!=-1:r.defaultValue==e.props.value}))),t.class&&!t.className?(r.class=t.class,Object.defineProperty(r,`className`,ih)):t.className&&(r.class=r.className=t.className),e.props=r}(e),e.$$typeof=Xm,ah&&ah(e)},oh=L.__r,L.__r=function(e){oh&&oh(e),rh=e.__c},sh=L.diffed,L.diffed=function(e){sh&&sh(e);var t=e.props,n=e.__e;n!=null&&e.type===`textarea`&&`value`in t&&t.value!==n.value&&(n.value=t.value==null?``:t.value),rh=null},ch={ReactCurrentDispatcher:{current:{readContext:function(e){return rh.__n[e.__c].props.value},useCallback:H,useContext:ke,useDebugValue:Ae,useDeferredValue:ym,useEffect:z,useId:Me,useImperativeHandle:Oe,useInsertionEffect:Hm,useLayoutEffect:De,useMemo:V,useReducer:Ee,useRef:B,useState:R,useSyncExternalStore:gm,useTransition:bm}}},lh=`18.3.1`,uh=function(e,t){return e(t)},dh=function(e,t){var n=L.debounceRendering;L.debounceRendering=function(e){return e()};var r=e(t);return L.debounceRendering=n,r},fh=Im,ph={useState:R,useId:Me,useReducer:Ee,useEffect:z,useLayoutEffect:De,useInsertionEffect:Hm,useTransition:bm,useDeferredValue:ym,useSyncExternalStore:gm,startTransition:vm,useRef:B,useImperativeHandle:Oe,useMemo:V,useCallback:H,useContext:ke,useDebugValue:Ae,version:`18.3.1`,Children:Km,render:Nm,hydrate:Pm,unmountComponentAtNode:Bm,createPortal:Mm,createElement:h,createContext:ce,createFactory:Fm,cloneElement:zm,createRef:_,Fragment:v,isValidElement:Im,isElement:fh,isFragment:Lm,isMemo:Rm,findDOMNode:Vm,Component:y,PureComponent:xm,memo:Sm,forwardRef:Cm,flushSync:dh,unstable_batchedUpdates:uh,StrictMode:v,Suspense:Em,SuspenseList:km,lazy:Om,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:ch}}));function mh(e,t){return function(n,...r){let i=new URL(e);return i.searchParams.set(`code`,n.toString()),r.forEach(e=>i.searchParams.append(`args[]`,e)),`${t} error #${n}; visit ${i} for the full message.`}}var hh=mh(`https://base-ui.com/production-error`,`Base UI`);Z();var gh=ce(void 0);function _h(e){let t=ke(gh);if(e===!1&&t===void 0)throw Error(hh(27));return t}Z();var vh={};function yh(e,t){let n=B(vh);return n.current===vh&&(n.current=e(t)),n}function bh(e,t,n,r){let i=yh(Sh).current;return Ch(i,e,t,n,r)&&Th(i,[e,t,n,r]),i.callback}function xh(e){let t=yh(Sh).current;return wh(t,e)&&Th(t,e),t.callback}function Sh(){return{callback:null,cleanup:null,refs:[]}}function Ch(e,t,n,r,i){return e.refs[0]!==t||e.refs[1]!==n||e.refs[2]!==r||e.refs[3]!==i}function wh(e,t){return e.refs.length!==t.length||e.refs.some((e,n)=>e!==t[n])}function Th(e,t){if(e.refs=t,t.every(e=>e==null)){e.callback=null;return}e.callback=n=>{if(e.cleanup&&=(e.cleanup(),null),n!=null){let r=Array(t.length).fill(null);for(let e=0;e<t.length;e+=1){let i=t[e];if(i!=null)switch(typeof i){case`function`:{let t=i(n);typeof t==`function`&&(r[e]=t);break}case`object`:i.current=n;break;default:}}e.cleanup=()=>{for(let e=0;e<t.length;e+=1){let n=t[e];if(n!=null)switch(typeof n){case`function`:{let t=r[e];typeof t==`function`?t():n(null);break}case`object`:n.current=null;break;default:}}}}}}Z();var Eh=parseInt(lh,10);function Dh(e){return Eh>=e}Z();function Oh(e){if(!Im(e))return null;let t=e,n=t.props;return(Dh(19)?n?.ref:t.ref)??null}function kh(e,t){if(e&&!t)return e;if(!e&&t)return t;if(e||t)return{...e,...t}}function Ah(e,t){let n={};for(let r in e){let i=e[r];if(t?.hasOwnProperty(r)){let e=t[r](i);e!=null&&Object.assign(n,e);continue}i===!0?n[`data-${r.toLowerCase()}`]=``:i&&(n[`data-${r.toLowerCase()}`]=i.toString())}return n}function jh(e,t){return typeof e==`function`?e(t):e}function Mh(e,t){return typeof e==`function`?e(t):e}var Nh={};function Ph(e,t,n,r,i){let a={...Bh(e,Nh)};return t&&(a=Ih(a,t)),n&&(a=Ih(a,n)),r&&(a=Ih(a,r)),i&&(a=Ih(a,i)),a}function Fh(e){if(e.length===0)return Nh;if(e.length===1)return Bh(e[0],Nh);let t={...Bh(e[0],Nh)};for(let n=1;n<e.length;n+=1)t=Ih(t,e[n]);return t}function Ih(e,t){return zh(t)?t(e):Lh(e,t)}function Lh(e,t){if(!t)return e;for(let n in t){let r=t[n];switch(n){case`style`:e[n]=kh(e.style,r);break;case`className`:e[n]=Uh(e.className,r);break;default:Rh(n,r)?e[n]=Vh(e[n],r):e[n]=r}}return e}function Rh(e,t){let n=e.charCodeAt(0),r=e.charCodeAt(1),i=e.charCodeAt(2);return n===111&&r===110&&i>=65&&i<=90&&(typeof t==`function`||t===void 0)}function zh(e){return typeof e==`function`}function Bh(e,t){return zh(e)?e(t):e??Nh}function Vh(e,t){return t?e?n=>{if(Wh(n)){let r=n;Hh(r);let i=t(r);return r.baseUIHandlerPrevented||e?.(r),i}let r=t(n);return e?.(n),r}:t:e}function Hh(e){return e.preventBaseUIHandler=()=>{e.baseUIHandlerPrevented=!0},e}function Uh(e,t){return t?e?t+` `+e:t:e}function Wh(e){return typeof e==`object`&&!!e&&`nativeEvent`in e}function Gh(){}Object.freeze([]);var Kh=Object.freeze({}),qh={clipPath:`inset(50%)`,position:`fixed`,top:0,left:0};Z();function Jh(e,t,n={}){let r=t.render,i=Yh(t,n);return n.enabled===!1?null:Zh(e,r,i,n.state??Kh)}function Yh(e,t={}){let{className:n,style:r,render:i}=e,{state:a=Kh,ref:o,props:s,stateAttributesMapping:c,enabled:l=!0}=t,u=l?jh(n,a):void 0,d=l?Mh(r,a):void 0,f=l?Ah(a,c):Kh,p=l?kh(f,Array.isArray(s)?Fh(s):s)??Kh:Kh;return typeof document<`u`&&(l?Array.isArray(o)?p.ref=xh([p.ref,Oh(i),...o]):p.ref=bh(p.ref,Oh(i),o):bh(null,null)),l?(u!==void 0&&(p.className=Uh(p.className,u)),d!==void 0&&(p.style=kh(p.style,d)),p):Kh}var Xh=Symbol.for(`react.lazy`);function Zh(e,t,n,r){if(t){if(typeof t==`function`)return t(n,r);let e=Ph(n,t.props);e.ref=n.ref;let i=t;return i?.$$typeof===Xh&&(i=Km.toArray(t)[0]),zm(i,e)}if(e&&typeof e==`string`)return Qh(e,n);throw Error(hh(8))}function Qh(e,t){return e===`button`?h(`button`,{type:`button`,...t,key:t.key}):e===`img`?h(`img`,{alt:``,...t,key:t.key}):h(e,t)}var $h=function(e){return e.startingStyle=`data-starting-style`,e.endingStyle=`data-ending-style`,e}({}),eg={[$h.startingStyle]:``},tg={[$h.endingStyle]:``},ng={transitionStatus(e){return e===`starting`?eg:e===`ending`?tg:null}},rg=function(e){return e.open=`data-open`,e.closed=`data-closed`,e[e.startingStyle=$h.startingStyle]=`startingStyle`,e[e.endingStyle=$h.endingStyle]=`endingStyle`,e.anchorHidden=`data-anchor-hidden`,e.side=`data-side`,e.align=`data-align`,e}({}),ig=function(e){return e.popupOpen=`data-popup-open`,e.pressed=`data-pressed`,e}({});ig.popupOpen,ig.popupOpen,ig.pressed;var ag={[rg.open]:``},og={[rg.closed]:``},sg={[rg.anchorHidden]:``},cg={open(e){return e?ag:og},anchorHidden(e){return e?sg:null}},lg=function(e){return e.nestedDrawers=`--nested-drawers`,e.height=`--drawer-height`,e.frontmostHeight=`--drawer-frontmost-height`,e.swipeMovementX=`--drawer-swipe-movement-x`,e.swipeMovementY=`--drawer-swipe-movement-y`,e.snapPointOffset=`--drawer-snap-point-offset`,e.swipeStrength=`--drawer-swipe-strength`,e}({}),ug=function(e){return e.swipeProgress=`--drawer-swipe-progress`,e}({});Z();var dg={...cg,...ng},fg=Cm(function(e,t){let{render:n,className:r,forceRender:i=!1,...a}=e,{store:o}=_h(),s=o.useState(`open`),c=o.useState(`nested`),l=o.useState(`mounted`);return Jh(`div`,e,{state:{open:s,transitionStatus:o.useState(`transitionStatus`)},ref:[o.context.backdropRef,t],stateAttributesMapping:dg,props:[{role:`presentation`,hidden:!l,style:{pointerEvents:s?void 0:`none`,userSelect:`none`,WebkitUserSelect:`none`,[ug.swipeProgress]:`0`,[lg.swipeStrength]:`1`}},a],enabled:i||!c})});function pg(){return typeof window<`u`}function mg(e){return _g(e)?(e.nodeName||``).toLowerCase():`#document`}function hg(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function gg(e){return((_g(e)?e.ownerDocument:e.document)||window.document)?.documentElement}function _g(e){return pg()?e instanceof Node||e instanceof hg(e).Node:!1}function vg(e){return pg()?e instanceof Element||e instanceof hg(e).Element:!1}function yg(e){return pg()?e instanceof HTMLElement||e instanceof hg(e).HTMLElement:!1}function bg(e){return!pg()||typeof ShadowRoot>`u`?!1:e instanceof ShadowRoot||e instanceof hg(e).ShadowRoot}function xg(e){let{overflow:t,overflowX:n,overflowY:r,display:i}=Tg(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&i!==`inline`&&i!==`contents`}var Sg;function Cg(){return Sg??=typeof CSS<`u`&&CSS.supports&&CSS.supports(`-webkit-backdrop-filter`,`none`),Sg}function wg(e){return/^(html|body|#document)$/.test(mg(e))}function Tg(e){return hg(e).getComputedStyle(e)}function Eg(e){if(mg(e)===`html`)return e;let t=e.assignedSlot||e.parentNode||bg(e)&&e.host||gg(e);return bg(t)?t.host:t}Z();var Dg=pm[`useInsertionEffect${Math.random().toFixed(1)}`.slice(0,-3)],Og=Dg&&Dg!==De?Dg:e=>e();function Q(e){let t=yh(kg).current;return t.next=e,Og(t.effect),t.trampoline}function kg(){let e={next:void 0,callback:Ag,trampoline:(...t)=>e.callback?.(...t),effect:()=>{e.callback=e.next}};return e}function Ag(){}Z();var jg={...pm};Z();var Mg=typeof document<`u`?De:()=>{},Ng=`trigger-press`,Pg=`outside-press`,Fg=`focus-out`,Ig=`escape-key`,Lg=`close-watcher`,Rg=`imperative-action`;function zg(e,t,n,r){let i=!1,a=!1,o=r??Kh;return{reason:e,event:t??new Event(`base-ui`),cancel(){i=!0},allowPropagation(){a=!0},get isCanceled(){return i},get isPropagationAllowed(){return a},trigger:n,...o}}Z();var Bg=0;function Vg(e,t=`mui`){let[n,r]=R(e),i=e||n;return z(()=>{n??(Bg+=1,r(`${t}-${Bg}`))},[n,t]),i}var Hg=jg.useId;function Ug(e,t){if(Hg!==void 0){let n=Hg();return e??(t?`${t}-${n}`:n)}return Vg(e,t)}Z();var Wg=ce(void 0);function Gg(e){let t=ke(Wg);if(e===!1&&t===void 0)throw Error(hh(91));return t}Z();var Kg=[];function qg(e){z(e,Kg)}var Jg=0,Yg=class e{static create(){return new e}currentId=Jg;start(e,t){this.clear(),this.currentId=setTimeout(()=>{this.currentId=Jg,t()},e)}isStarted(){return this.currentId!==Jg}clear=()=>{this.currentId!==Jg&&(clearTimeout(this.currentId),this.currentId=Jg)};disposeEffect=()=>this.clear};function Xg(){let e=yh(Yg.create).current;return qg(e.disposeEffect),e}var Zg=typeof navigator<`u`,Qg=o_(),$g=c_(),e_=s_(),t_=typeof CSS>`u`||!CSS.supports?!1:CSS.supports(`-webkit-backdrop-filter:none`),n_=Qg.platform===`MacIntel`&&Qg.maxTouchPoints>1?!0:/iP(hone|ad|od)|iOS/.test(Qg.platform);Zg&&/firefox/i.test(e_);var r_=Zg&&/apple/i.test(navigator.vendor);Zg&&/Edg/i.test(e_);var i_=Zg&&/android/i.test($g)||/android/i.test(e_);Zg&&$g.toLowerCase().startsWith(`mac`)&&navigator.maxTouchPoints;var a_=e_.includes(`jsdom/`);function o_(){if(!Zg)return{platform:``,maxTouchPoints:-1};let e=navigator.userAgentData;return e?.platform?{platform:e.platform,maxTouchPoints:navigator.maxTouchPoints}:{platform:navigator.platform??``,maxTouchPoints:navigator.maxTouchPoints??-1}}function s_(){if(!Zg)return``;let e=navigator.userAgentData;return e&&Array.isArray(e.brands)?e.brands.map(({brand:e,version:t})=>`${e}/${t}`).join(` `):navigator.userAgent}function c_(){if(!Zg)return``;let e=navigator.userAgentData;return e?.platform?e.platform:navigator.platform??``}var l_=`data-base-ui-focusable`;function u_(e){let t=e.activeElement;for(;t?.shadowRoot?.activeElement!=null;)t=t.shadowRoot.activeElement;return t}function d_(e,t){if(!e||!t)return!1;let n=t.getRootNode?.();if(e.contains(t))return!0;if(n&&bg(n)){let n=t;for(;n;){if(e===n)return!0;n=n.parentNode||n.host}}return!1}function f_(e){return`composedPath`in e?e.composedPath()[0]:e.target}function p_(e,t){if(t==null)return!1;if(`composedPath`in e)return e.composedPath().includes(t);let n=e;return n.target!=null&&t.contains(n.target)}function m_(e){return e.matches(`html,body`)}function h_(e){return yg(e)&&e.matches(`input:not([type='hidden']):not([disabled]),[contenteditable]:not([contenteditable='false']),textarea:not([disabled])`)}function g_(e){return e?e.getAttribute(`role`)===`combobox`&&h_(e):!1}function __(e){return e?e.hasAttribute(`data-base-ui-focusable`)?e:e.querySelector(`[data-base-ui-focusable]`)||e:null}function v_(e,t,n=!0){return e.filter(e=>e.parentId===t&&(!n||e.context?.open)).flatMap(t=>[t,...v_(e,t.id,n)])}function y_(e,t){let n=[],r=e.find(e=>e.id===t)?.parentId;for(;r;){let t=e.find(e=>e.id===r);r=t?.parentId,t&&(n=n.concat(t))}return n}function b_(e){e.preventDefault(),e.stopPropagation()}function x_(e){return`nativeEvent`in e}function S_(e){return e.pointerType===``&&e.isTrusted?!0:i_&&e.pointerType?e.type===`click`&&e.buttons===1:e.detail===0&&!e.pointerType}function C_(e){return a_?!1:!i_&&e.width===0&&e.height===0||i_&&e.width===1&&e.height===1&&e.pressure===0&&e.detail===0&&e.pointerType===`mouse`||e.width<1&&e.height<1&&e.pressure===0&&e.detail===0&&e.pointerType===`touch`}function w_(e){let t=e.type;return t===`click`||t===`mousedown`||t===`keydown`||t===`keyup`}function T_(e){return Tg(e).display!==`none`}var E_=[`input:not([inert]):not([inert] *)`,`select:not([inert]):not([inert] *)`,`textarea:not([inert]):not([inert] *)`,`a[href]:not([inert]):not([inert] *)`,`button:not([inert]):not([inert] *)`,`[tabindex]:not(slot):not([inert]):not([inert] *)`,`audio[controls]:not([inert]):not([inert] *)`,`video[controls]:not([inert]):not([inert] *)`,`[contenteditable]:not([contenteditable="false"]):not([inert]):not([inert] *)`,`details>summary:first-of-type:not([inert]):not([inert] *)`,`details:not([inert]):not([inert] *)`].join(`,`),D_=typeof Element>`u`,O_=D_?function(){}:Element.prototype.matches||Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector,k_=!D_&&Element.prototype.getRootNode?function(e){return e?.getRootNode?.call(e)}:function(e){return e?.ownerDocument},A_=function(e,t){t===void 0&&(t=!0);var n=e?.getAttribute?.call(e,`inert`);return n===``||n===`true`||t&&e&&(typeof e.closest==`function`?e.closest(`[inert]`):A_(e.parentNode))},j_=function(e){var t=e?.getAttribute?.call(e,`contenteditable`);return t===``||t===`true`},M_=function(e,t,n){if(A_(e))return[];var r=Array.prototype.slice.apply(e.querySelectorAll(E_));return t&&O_.call(e,E_)&&r.unshift(e),r=r.filter(n),r},N_=function(e,t,n){for(var r=[],i=Array.from(e);i.length;){var a=i.shift();if(!A_(a,!1))if(a.tagName===`SLOT`){var o=a.assignedElements(),s=N_(o.length?o:a.children,!0,n);n.flatten?r.push.apply(r,s):r.push({scopeParent:a,candidates:s})}else{O_.call(a,E_)&&n.filter(a)&&(t||!e.includes(a))&&r.push(a);var c=a.shadowRoot||typeof n.getShadowRoot==`function`&&n.getShadowRoot(a),l=!A_(c,!1)&&(!n.shadowRootFilter||n.shadowRootFilter(a));if(c&&l){var u=N_(c===!0?a.children:c.children,!0,n);n.flatten?r.push.apply(r,u):r.push({scopeParent:a,candidates:u})}else i.unshift.apply(i,a.children)}}return r},P_=function(e){return!isNaN(parseInt(e.getAttribute(`tabindex`),10))},F_=function(e){if(!e)throw Error(`No node provided`);return e.tabIndex<0&&(/^(AUDIO|VIDEO|DETAILS)$/.test(e.tagName)||j_(e))&&!P_(e)?0:e.tabIndex},I_=function(e,t){var n=F_(e);return n<0&&t&&!P_(e)?0:n},L_=function(e,t){return e.tabIndex===t.tabIndex?e.documentOrder-t.documentOrder:e.tabIndex-t.tabIndex},R_=function(e){return e.tagName===`INPUT`},z_=function(e){return R_(e)&&e.type===`hidden`},B_=function(e){return e.tagName===`DETAILS`&&Array.prototype.slice.apply(e.children).some(function(e){return e.tagName===`SUMMARY`})},V_=function(e,t){for(var n=0;n<e.length;n++)if(e[n].checked&&e[n].form===t)return e[n]},H_=function(e){if(!e.name)return!0;var t=e.form||k_(e),n=function(e){return t.querySelectorAll(`input[type="radio"][name="`+e+`"]`)},r;if(typeof window<`u`&&window.CSS!==void 0&&typeof window.CSS.escape==`function`)r=n(window.CSS.escape(e.name));else try{r=n(e.name)}catch(e){return console.error(`Looks like you have a radio button with a name attribute containing invalid CSS selector characters and need the CSS.escape polyfill: %s`,e.message),!1}var i=V_(r,e.form);return!i||i===e},U_=function(e){return R_(e)&&e.type===`radio`},W_=function(e){return U_(e)&&!H_(e)},G_=function(e){var t=e&&k_(e),n=t?.host,r=!1;if(t&&t!==e){var i,a,o;for(r=!!((i=n)!=null&&(a=i.ownerDocument)!=null&&a.contains(n)||e!=null&&(o=e.ownerDocument)!=null&&o.contains(e));!r&&n;){var s,c;t=k_(n),n=t?.host,r=!!((s=n)!=null&&(c=s.ownerDocument)!=null&&c.contains(n))}}return r},K_=function(e){var t=e.getBoundingClientRect(),n=t.width,r=t.height;return n===0&&r===0},q_=function(e,t){var n=t.displayCheck,r=t.getShadowRoot;if(n===`full-native`&&`checkVisibility`in e)return!e.checkVisibility({checkOpacity:!1,opacityProperty:!1,contentVisibilityAuto:!0,visibilityProperty:!0,checkVisibilityCSS:!0});if(getComputedStyle(e).visibility===`hidden`)return!0;var i=O_.call(e,`details>summary:first-of-type`)?e.parentElement:e;if(O_.call(i,`details:not([open]) *`))return!0;if(!n||n===`full`||n===`full-native`||n===`legacy-full`){if(typeof r==`function`){for(var a=e;e;){var o=e.parentElement,s=k_(e);if(o&&!o.shadowRoot&&r(o)===!0)return K_(e);e=e.assignedSlot?e.assignedSlot:!o&&s!==e.ownerDocument?s.host:o}e=a}if(G_(e))return!e.getClientRects().length;if(n!==`legacy-full`)return!0}else if(n===`non-zero-area`)return K_(e);return!1},J_=function(e){if(/^(INPUT|BUTTON|SELECT|TEXTAREA)$/.test(e.tagName))for(var t=e.parentElement;t;){if(t.tagName===`FIELDSET`&&t.disabled){for(var n=0;n<t.children.length;n++){var r=t.children.item(n);if(r.tagName===`LEGEND`)return O_.call(t,`fieldset[disabled] *`)?!0:!r.contains(e)}return!0}t=t.parentElement}return!1},Y_=function(e,t){return!(t.disabled||z_(t)||q_(t,e)||B_(t)||J_(t))},X_=function(e,t){return!(W_(t)||F_(t)<0||!Y_(e,t))},Z_=function(e){var t=parseInt(e.getAttribute(`tabindex`),10);return!!(isNaN(t)||t>=0)},Q_=function(e){var t=[],n=[];return e.forEach(function(e,r){var i=!!e.scopeParent,a=i?e.scopeParent:e,o=I_(a,i),s=i?Q_(e.candidates):a;o===0?i?t.push.apply(t,s):t.push(a):n.push({documentOrder:r,tabIndex:o,item:e,isScope:i,content:s})}),n.sort(L_).reduce(function(e,t){return t.isScope?e.push.apply(e,t.content):e.push(t.content),e},[]).concat(t)},$_=function(e,t){return t||={},Q_(t.getShadowRoot?N_([e],t.includeContainer,{filter:X_.bind(null,t),flatten:!1,getShadowRoot:t.getShadowRoot,shadowRootFilter:Z_}):M_(e,t.includeContainer,X_.bind(null,t)))},ev=function(e,t){return t||={},t.getShadowRoot?N_([e],t.includeContainer,{filter:Y_.bind(null,t),flatten:!0,getShadowRoot:t.getShadowRoot}):M_(e,t.includeContainer,Y_.bind(null,t))},tv=function(e,t){if(t||={},!e)throw Error(`No node provided`);return O_.call(e,E_)===!1?!1:X_(t,e)};function nv(e){return e?.ownerDocument||document}var rv=()=>({getShadowRoot:!0,displayCheck:typeof ResizeObserver==`function`&&ResizeObserver.toString().includes(`[native code]`)?`full`:`none`});function iv(e,t){let n=$_(e,rv()),r=n.length;if(r===0)return;let i=u_(nv(e)),a=n.indexOf(i);return n[a===-1?t===1?0:r-1:a+t]}function av(e){return iv(nv(e).body,1)||e}function ov(e){return iv(nv(e).body,-1)||e}function sv(e,t){let n=t||e.currentTarget,r=e.relatedTarget;return!r||!d_(n,r)}function cv(e){$_(e,rv()).forEach(e=>{e.dataset.tabindex=e.getAttribute(`tabindex`)||``,e.setAttribute(`tabindex`,`-1`)})}function lv(e){e.querySelectorAll(`[data-tabindex]`).forEach(e=>{let t=e.dataset.tabindex;delete e.dataset.tabindex,t?e.setAttribute(`tabindex`,t):e.removeAttribute(`tabindex`)})}we();var uv=0;Array.isArray;function $(e,t,n,r,i,a){t||={};var o,s,c=t;if(`ref`in c)for(s in c={},t)s==`ref`?o=t[s]:c[s]=t[s];var l={type:e,props:c,key:n,ref:o,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:--uv,__i:-1,__u:0,__source:i,__self:a};if(typeof e==`function`&&(o=e.defaultProps))for(s in o)c[s]===void 0&&(c[s]=o[s]);return L.vnode&&L.vnode(l),l}function dv(e){let t=yh(fv,e).current;return t.next=e,Mg(t.effect),t}function fv(e){let t={current:e,next:e,effect:()=>{t.current=t.next}};return t}var pv=null;globalThis.requestAnimationFrame;var mv=new class{callbacks=[];callbacksCount=0;nextId=1;startId=1;isScheduled=!1;tick=e=>{this.isScheduled=!1;let t=this.callbacks,n=this.callbacksCount;if(this.callbacks=[],this.callbacksCount=0,this.startId=this.nextId,n>0)for(let n=0;n<t.length;n+=1)t[n]?.(e)};request(e){let t=this.nextId;return this.nextId+=1,this.callbacks.push(e),this.callbacksCount+=1,this.isScheduled||=(requestAnimationFrame(this.tick),!0),t}cancel(e){let t=e-this.startId;t<0||t>=this.callbacks.length||(this.callbacks[t]=null,--this.callbacksCount)}},hv=class e{static create(){return new e}static request(e){return mv.request(e)}static cancel(e){return mv.cancel(e)}currentId=pv;request(e){this.cancel(),this.currentId=mv.request(()=>{this.currentId=pv,e()})}cancel=()=>{this.currentId!==pv&&(mv.cancel(this.currentId),this.currentId=pv)};disposeEffect=()=>this.cancel};function gv(){let e=yh(hv.create).current;return qg(e.disposeEffect),e}var _v={clipPath:`inset(50%)`,overflow:`hidden`,whiteSpace:`nowrap`,border:0,padding:0,width:1,height:1,margin:-1},vv={..._v,position:`fixed`,top:0,left:0};({..._v}),Z();var yv=Cm(function(e,t){let[n,r]=R();Mg(()=>{r_&&r(`button`)},[]);let i={tabIndex:0,role:n};return $(`span`,{...e,ref:t,style:vv,"aria-hidden":n?void 0:!0,...i,"data-base-ui-focus-guard":``})});function bv(e){return`data-base-ui-${e}`}var xv=0;function Sv(e,t={}){let{preventScroll:n=!1,cancelPrevious:r=!0,sync:i=!1}=t;r&&cancelAnimationFrame(xv);let a=()=>e?.focus({preventScroll:n});i?a():xv=requestAnimationFrame(a)}var Cv={inert:new WeakMap,"aria-hidden":new WeakMap},wv=`data-base-ui-inert`,Tv={inert:new WeakSet,"aria-hidden":new WeakSet},Ev=new WeakMap,Dv=0;function Ov(e){return Tv[e]}function kv(e){return e?bg(e)?e.host:kv(e.parentNode):null}var Av=(e,t)=>t.map(t=>{if(e.contains(t))return t;let n=kv(t);return e.contains(n)?n:null}).filter(e=>e!=null),jv=e=>{let t=new Set;return e.forEach(e=>{let n=e;for(;n&&!t.has(n);)t.add(n),n=n.parentNode}),t},Mv=(e,t,n)=>{let r=[],i=e=>{!e||n.has(e)||Array.from(e.children).forEach(e=>{mg(e)!==`script`&&(t.has(e)?i(e):r.push(e))})};return i(e),r};function Nv(e,t,n,r,{mark:i=!0,markerIgnoreElements:a=[]}){let o=r?`inert`:n?`aria-hidden`:null,s=null,c=null,l=Av(t,e),u=i?Av(t,a):[],d=new Set(u),f=i?Mv(t,jv(l),new Set(l)).filter(e=>!d.has(e)):[],p=[],m=[];if(o){let e=Cv[o],n=Ov(o);c=n,s=e;let r=Av(t,Array.from(t.querySelectorAll(`[aria-live]`))),i=l.concat(r);Mv(t,jv(i),new Set(i)).forEach(t=>{let r=t.getAttribute(o),i=r!==null&&r!==`false`,a=(e.get(t)||0)+1;e.set(t,a),p.push(t),a===1&&i&&n.add(t),i||t.setAttribute(o,o===`inert`?``:`true`)})}return i&&f.forEach(e=>{let t=(Ev.get(e)||0)+1;Ev.set(e,t),m.push(e),t===1&&e.setAttribute(wv,``)}),Dv+=1,()=>{s&&p.forEach(e=>{let t=(s.get(e)||0)-1;s.set(e,t),t||(!c?.has(e)&&o&&e.removeAttribute(o),c?.delete(e))}),i&&m.forEach(e=>{let t=(Ev.get(e)||0)-1;Ev.set(e,t),t||e.removeAttribute(wv)}),--Dv,Dv||(Cv.inert=new WeakMap,Cv[`aria-hidden`]=new WeakMap,Tv.inert=new WeakSet,Tv[`aria-hidden`]=new WeakSet,Ev=new WeakMap)}}function Pv(e,t={}){let{ariaHidden:n=!1,inert:r=!1,mark:i=!0,markerIgnoreElements:a=[]}=t,o=nv(e[0]).body;return Nv(e,o,n,r,{mark:i,markerIgnoreElements:a})}Z();var Fv=ce(null),Iv=()=>ke(Fv),Lv=bv(`portal`);function Rv(e={}){let{ref:t,container:n,componentProps:r=Kh,elementProps:i}=e,a=Ug(),o=Iv()?.portalNode,[s,c]=R(null),[l,u]=R(null),d=Q(e=>{e!==null&&u(e)}),f=B(null);Mg(()=>{if(n===null){f.current&&(f.current=null,u(null),c(null));return}if(a==null)return;let e=(n&&(_g(n)?n:n.current))??o??document.body;if(e==null){f.current&&(f.current=null,u(null),c(null));return}f.current!==e&&(f.current=e,u(null),c(e))},[n,o,a]);let p=Jh(`div`,r,{ref:[t,d],props:[{id:a,[Lv]:``},i]});return{portalNode:l,portalSubtree:s&&p?Mm(p,s):null}}var zv=Cm(function(e,t){let{children:n,container:r,className:i,render:a,renderGuards:o,...s}=e,{portalNode:c,portalSubtree:l}=Rv({container:r,ref:t,componentProps:e,elementProps:s}),u=B(null),d=B(null),f=B(null),p=B(null),[m,h]=R(null),g=m?.modal,_=m?.open,y=typeof o==`boolean`?o:!!m&&!m.modal&&m.open&&!!c;z(()=>{if(!c||g)return;function e(e){c&&e.relatedTarget&&sv(e)&&(e.type===`focusin`?lv:cv)(c)}return c.addEventListener(`focusin`,e,!0),c.addEventListener(`focusout`,e,!0),()=>{c.removeEventListener(`focusin`,e,!0),c.removeEventListener(`focusout`,e,!0)}},[c,g]),z(()=>{!c||_||lv(c)},[_,c]);let b=V(()=>({beforeOutsideRef:u,afterOutsideRef:d,beforeInsideRef:f,afterInsideRef:p,portalNode:c,setFocusManagerState:h}),[c]);return $(v,{children:[l,$(Fv.Provider,{value:b,children:[y&&c&&$(yv,{"data-type":`outside`,ref:u,onFocus:e=>{sv(e,c)?f.current?.focus():ov(m?m.domReference:null)?.focus()}}),y&&c&&$(`span`,{"aria-owns":c.id,style:qh}),c&&Mm(n,c),y&&c&&$(yv,{"data-type":`outside`,ref:d,onFocus:e=>{sv(e,c)?p.current?.focus():(av(m?m.domReference:null)?.focus(),m?.closeOnFocusOut&&m?.onOpenChange(!1,zg(`focus-out`,e.nativeEvent)))}})]})]})});function Bv(){let e=new Map;return{emit(t,n){e.get(t)?.forEach(e=>e(n))},on(t,n){e.has(t)||e.set(t,new Set),e.get(t).add(n)},off(t,n){e.get(t)?.delete(n)}}}Z();var Vv=ce(null),Hv=ce(null),Uv=()=>ke(Vv)?.id||null,Wv=e=>{let t=ke(Hv);return e??t};function Gv(e){return e==null?e:`current`in e?e.current:e}Z();function Kv(e,t){let n=hg(e.target);return e instanceof n.KeyboardEvent?`keyboard`:e instanceof n.FocusEvent?t||`keyboard`:`pointerType`in e?e.pointerType||`keyboard`:`touches`in e?`touch`:e instanceof n.MouseEvent?t||(e.detail===0?`keyboard`:`mouse`):``}var qv=20,Jv=[];function Yv(){Jv=Jv.filter(e=>e.deref()?.isConnected)}function Xv(e){Yv(),e&&mg(e)!==`body`&&(Jv.push(new WeakRef(e)),Jv.length>qv&&(Jv=Jv.slice(-qv)))}function Zv(){return Yv(),Jv[Jv.length-1]?.deref()}function Qv(e){if(!e)return null;let t=rv();return tv(e,t)?e:$_(e,t)[0]||e}function $v(e){return!e||!e.isConnected?!1:typeof e.checkVisibility==`function`?e.checkVisibility():T_(e)}function ey(e,t){if(!t.current.includes(`floating`)&&!e.getAttribute(`role`)?.includes(`dialog`))return;let n=rv(),r=ev(e,n).filter(e=>{let t=e.getAttribute(`data-tabindex`)||``;return tv(e,n)||e.hasAttribute(`data-tabindex`)&&!t.startsWith(`-`)}),i=e.getAttribute(`tabindex`);t.current.includes(`floating`)||r.length===0?i!==`0`&&e.setAttribute(`tabindex`,`0`):(i!==`-1`||e.hasAttribute(`data-tabindex`)&&e.getAttribute(`data-tabindex`)!==`-1`)&&(e.setAttribute(`tabindex`,`-1`),e.setAttribute(`data-tabindex`,`-1`))}function ty(e){let{context:t,children:n,disabled:r=!1,initialFocus:i=!0,returnFocus:a=!0,restoreFocus:o=!1,modal:s=!0,closeOnFocusOut:c=!0,openInteractionType:l=``,nextFocusableElement:u,previousFocusableElement:d,beforeContentFocusGuardRef:f,externalTree:p,getInsideElements:m}=e,h=`rootStore`in t?t.rootStore:t,g=h.useState(`open`),_=h.useState(`domReferenceElement`),y=h.useState(`floatingElement`),{events:b,dataRef:x}=h.context,S=Q(()=>x.current.floatingContext?.nodeId),C=i===!1,w=g_(_)&&C,T=B([`content`]),E=dv(i),D=dv(a),O=dv(l),k=Wv(p),A=Iv(),j=B(!1),ee=B(!1),te=B(!1),ne=B(-1),re=B(``),ie=B(``),ae=B(null),M=B(null),N=bh(ae,f,A?.beforeInsideRef),P=bh(M,A?.afterInsideRef),F=Xg(),oe=Xg(),se=gv(),ce=A!=null,I=__(y),L=Q((e=I)=>e?$_(e,rv()):[]),le=Q(()=>m?.().filter(e=>e!=null)??[]),ue=Q(e=>{let t=L(e);return T.current.map(()=>t).filter(Boolean).flat()});z(()=>{if(r||!s)return;function e(e){e.key===`Tab`&&d_(I,u_(nv(I)))&&L().length===0&&!w&&b_(e)}let t=nv(I);return t.addEventListener(`keydown`,e),()=>{t.removeEventListener(`keydown`,e)}},[r,_,I,s,T,w,L,ue]),z(()=>{if(r||!g)return;let e=nv(I);function t(){te.current=!1}function n(e){let t=f_(e),n=le();te.current=!(d_(y,t)||d_(_,t)||d_(A?.portalNode,t)||n.some(e=>e===t||d_(e,t))),ie.current=e.pointerType||`keyboard`,t?.closest(`[data-base-ui-click-trigger]`)&&(ee.current=!0)}function i(){ie.current=`keyboard`}return e.addEventListener(`pointerdown`,n,!0),e.addEventListener(`pointerup`,t,!0),e.addEventListener(`pointercancel`,t,!0),e.addEventListener(`keydown`,i,!0),()=>{e.removeEventListener(`pointerdown`,n,!0),e.removeEventListener(`pointerup`,t,!0),e.removeEventListener(`pointercancel`,t,!0),e.removeEventListener(`keydown`,i,!0)}},[r,y,_,I,g,A,le]),z(()=>{if(r||!c)return;let e=nv(I);function t(){ee.current=!0,oe.start(0,()=>{ee.current=!1})}function n(e){let t=f_(e),n=L().indexOf(t);n!==-1&&(ne.current=n)}function i(t){let n=t.relatedTarget,r=t.currentTarget,i=f_(t);queueMicrotask(()=>{let a=S(),c=h.context.triggerElements,l=le(),f=n?.hasAttribute(bv(`focus-guard`))&&[ae.current,M.current,A?.beforeInsideRef.current,A?.afterInsideRef.current,A?.beforeOutsideRef.current,A?.afterOutsideRef.current,Gv(d),Gv(u)].includes(n),p=!(d_(_,n)||d_(y,n)||d_(n,y)||d_(A?.portalNode,n)||l.some(e=>e===n||d_(e,n))||n!=null&&c.hasElement(n)||c.hasMatchingElement(e=>d_(e,n))||f||k&&(v_(k.nodesRef.current,a).find(e=>d_(e.context?.elements.floating,n)||d_(e.context?.elements.domReference,n))||y_(k.nodesRef.current,a).find(e=>[e.context?.elements.floating,__(e.context?.elements.floating)].includes(n)||e.context?.elements.domReference===n)));if(r===_&&I&&ey(I,T),o&&r!==_&&!$v(i)&&u_(e)===e.body){if(yg(I)&&(I.focus(),o===`popup`)){se.request(()=>{I.focus()});return}let e=ne.current,t=L(),n=t[e]||t[t.length-1]||I;yg(n)&&n.focus()}if(x.current.insideReactTree){x.current.insideReactTree=!1;return}(w||!s)&&n&&p&&!ee.current&&(w||n!==Zv())&&(j.current=!0,h.setOpen(!1,zg(Fg,t)))})}function a(){te.current||(x.current.insideReactTree=!0,F.start(0,()=>{x.current.insideReactTree=!1}))}let l=yg(_)?_:null,f=[];if(!(!y&&!l))return l&&(l.addEventListener(`focusout`,i),l.addEventListener(`pointerdown`,t),f.push(()=>{l.removeEventListener(`focusout`,i),l.removeEventListener(`pointerdown`,t)})),y&&(y.addEventListener(`focusin`,n),y.addEventListener(`focusout`,i),A&&(y.addEventListener(`focusout`,a,!0),f.push(()=>{y.removeEventListener(`focusout`,a,!0)})),f.push(()=>{y.removeEventListener(`focusin`,n),y.removeEventListener(`focusout`,i)})),()=>{f.forEach(e=>{e()})}},[r,_,y,I,s,k,A,h,c,o,L,w,S,T,x,F,oe,se,u,d,le]),z(()=>{if(r||!y||!g)return;let e=Array.from(A?.portalNode?.querySelectorAll(`[${bv(`portal`)}]`)||[]),t=(k?y_(k.nodesRef.current,S()):[]).find(e=>g_(e.context?.elements.domReference||null))?.context?.elements.domReference,n=Pv([...[y,...e,ae.current,M.current,A?.beforeOutsideRef.current,A?.afterOutsideRef.current,...le()],t,Gv(d),Gv(u),w?_:null].filter(e=>e!=null),{ariaHidden:s||w,mark:!1}),i=Pv([y,...e].filter(e=>e!=null));return()=>{i(),n()}},[g,r,_,y,s,T,A,w,k,S,u,d,le]),Mg(()=>{if(!g||r||!yg(I))return;let e=u_(nv(I));queueMicrotask(()=>{let t=ue(I),n=E.current,r=typeof n==`function`?n(O.current||``):n;if(r===void 0||r===!1)return;let i;i=r===!0||r===null?t[0]||I:Gv(r),i=i||t[0]||I,!d_(I,e)&&Sv(i,{preventScroll:i===I})})},[r,g,I,C,ue,E,O]),Mg(()=>{if(r||!I)return;let e=nv(I);Xv(u_(e));function t(e){if(e.open||(re.current=Kv(e.nativeEvent,ie.current)),e.reason===`trigger-hover`&&e.nativeEvent.type===`mouseleave`&&(j.current=!0),e.reason===`outside-press`)if(e.nested)j.current=!1;else if(S_(e.nativeEvent)||C_(e.nativeEvent))j.current=!1;else{let e=!1;document.createElement(`div`).focus({get preventScroll(){return e=!0,!1}}),e?j.current=!1:j.current=!0}}b.on(`openchange`,t);function n(){let e=D.current,t=typeof e==`function`?e(re.current):e;if(t===void 0||t===!1)return null;if(t===null&&(t=!0),typeof t==`boolean`){let e=_||Zv();return e&&e.isConnected?e:null}let n=_||Zv();return Gv(t)||n||null}return()=>{b.off(`openchange`,t);let r=u_(e),i=le(),a=d_(y,r)||i.some(e=>e===r||d_(e,r))||k&&v_(k.nodesRef.current,S(),!1).some(e=>d_(e.context?.elements.floating,r)),o=n();queueMicrotask(()=>{let t=Qv(o),n=typeof D.current!=`boolean`;D.current&&!j.current&&yg(t)&&(!(!n&&t!==r&&r!==e.body)||a)&&t.focus({preventScroll:!0}),j.current=!1})}},[r,y,I,D,x,b,k,_,S,le]),Mg(()=>{if(!t_||g||!y)return;let e=u_(nv(y));!yg(e)||!h_(e)||d_(y,e)&&e.blur()},[g,y]),Mg(()=>{if(!(r||!A))return A.setFocusManagerState({modal:s,closeOnFocusOut:c,open:g,onOpenChange:h.setOpen,domReference:_}),()=>{A.setFocusManagerState(null)}},[r,A,s,g,h,c,_]),Mg(()=>{if(!(r||!I))return ey(I,T),()=>{queueMicrotask(Yv)}},[r,I,T]);let de=!r&&(s?!w:!0)&&(ce||s);return $(v,{children:[de&&$(yv,{"data-type":`inside`,ref:N,onFocus:e=>{if(s){let e=ue();Sv(e[e.length-1])}else A?.portalNode&&(j.current=!1,sv(e,A.portalNode)?av(_)?.focus():Gv(d??A.beforeOutsideRef)?.focus())}}),n,de&&$(yv,{"data-type":`inside`,ref:P,onFocus:e=>{s?Sv(ue()[0]):A?.portalNode&&(c&&(j.current=!0),sv(e,A.portalNode)?ov(_)?.focus():Gv(u??A.afterOutsideRef)?.focus())}})]})}Z();var ny={intentional:`onClick`,sloppy:`onPointerDown`};function ry(){return!1}function iy(e){return{escapeKey:typeof e==`boolean`?e:e?.escapeKey??!1,outsidePress:typeof e==`boolean`?e:e?.outsidePress??!0}}function ay(e,t={}){let n=`rootStore`in e?e.rootStore:e,r=n.useState(`open`),i=n.useState(`floatingElement`),{dataRef:a}=n.context,{enabled:o=!0,escapeKey:s=!0,outsidePress:c=!0,outsidePressEvent:l=`sloppy`,referencePress:u=ry,referencePressEvent:d=`sloppy`,bubbles:f,externalTree:p}=t,m=Wv(p),h=Q(typeof c==`function`?c:()=>!1),g=typeof c==`function`?h:c,_=g!==!1,v=Q(()=>l),y=B(!1),b=B(!1),x=B(!1),{escapeKey:S,outsidePress:C}=iy(f),w=B(null),T=Xg(),E=Xg(),D=Q(()=>{E.clear(),a.current.insideReactTree=!1}),O=B(!1),k=B(``),A=Q(u),j=Q(e=>{if(!r||!o||!s||e.key!==`Escape`||O.current)return;let t=a.current.floatingContext?.nodeId,i=m?v_(m.nodesRef.current,t):[];if(!S&&i.length>0){let e=!0;if(i.forEach(t=>{t.context?.open&&!t.context.dataRef.current.__escapeKeyBubbles&&(e=!1)}),!e)return}let c=zg(Ig,x_(e)?e.nativeEvent:e);n.setOpen(!1,c),!S&&!c.isPropagationAllowed&&e.stopPropagation()}),ee=Q(()=>{a.current.insideReactTree=!0,E.start(0,D)});z(()=>{if(!r||!o)return;a.current.__escapeKeyBubbles=S,a.current.__outsidePressBubbles=C;let e=new Yg,t=new Yg;function c(){e.clear(),O.current=!0}function l(){e.start(Cg()?5:0,()=>{O.current=!1})}function u(){x.current=!0,t.start(0,()=>{x.current=!1})}function d(){y.current=!1,b.current=!1}function f(){let e=k.current,t=e===`pen`||!e?`mouse`:e,n=v(),r=typeof n==`function`?n():n;return typeof r==`string`?r:r[t]}function p(e){let t=f();return t===`intentional`&&e.type!==`click`||t===`sloppy`&&e.type===`click`}function h(e){let t=a.current.floatingContext?.nodeId,r=m&&v_(m.nodesRef.current,t).some(t=>p_(e,t.context?.elements.floating));return p_(e,n.select(`floatingElement`))||p_(e,n.select(`domReferenceElement`))||r}function E(e){if(p(e)){D();return}if(a.current.insideReactTree){D();return}let r=f_(e),i=`[${bv(`inert`)}]`,o=Array.from(nv(n.select(`floatingElement`)).querySelectorAll(i)),s=vg(r)?r.getRootNode():null;bg(s)&&(o=o.concat(Array.from(s.querySelectorAll(i))));let c=n.context.triggerElements;if(r&&(c.hasElement(r)||c.hasMatchingElement(e=>d_(e,r))))return;let l=vg(r)?r:null;for(;l&&!wg(l);){let e=Eg(l);if(wg(e)||!vg(e))break;l=e}if(o.length&&vg(r)&&!m_(r)&&!d_(r,n.select(`floatingElement`))&&o.every(e=>!d_(l,e)))return;if(yg(r)&&!(`touches`in e)){let t=wg(r),n=Tg(r),i=/auto|scroll/,a=t||i.test(n.overflowX),o=t||i.test(n.overflowY),s=a&&r.clientWidth>0&&r.scrollWidth>r.clientWidth,c=o&&r.clientHeight>0&&r.scrollHeight>r.clientHeight,l=n.direction===`rtl`,u=c&&(l?e.offsetX<=r.offsetWidth-r.clientWidth:e.offsetX>r.clientWidth),d=s&&e.offsetY>r.clientHeight;if(u||d)return}if(h(e))return;if(f()===`intentional`&&x.current){t.clear(),x.current=!1;return}if(typeof g==`function`&&!g(e))return;let u=a.current.floatingContext?.nodeId,d=m?v_(m.nodesRef.current,u):[];if(d.length>0){let e=!0;if(d.forEach(t=>{t.context?.open&&!t.context.dataRef.current.__outsidePressBubbles&&(e=!1)}),!e)return}n.setOpen(!1,zg(Pg,e)),D()}function A(e){f()!==`sloppy`||e.pointerType===`touch`||!n.select(`open`)||!o||p_(e,n.select(`floatingElement`))||p_(e,n.select(`domReferenceElement`))||E(e)}function ee(e){if(f()!==`sloppy`||!n.select(`open`)||!o||p_(e,n.select(`floatingElement`))||p_(e,n.select(`domReferenceElement`)))return;let t=e.touches[0];t&&(w.current={startTime:Date.now(),startX:t.clientX,startY:t.clientY,dismissOnTouchEnd:!1,dismissOnMouseDown:!0},T.start(1e3,()=>{w.current&&(w.current.dismissOnTouchEnd=!1,w.current.dismissOnMouseDown=!1)}))}function te(e){k.current=`touch`;let t=f_(e);function n(){ee(e),t?.removeEventListener(e.type,n)}t?.addEventListener(e.type,n)}function ne(e){if(T.clear(),e.type===`pointerdown`&&(k.current=e.pointerType),e.type===`mousedown`&&w.current&&!w.current.dismissOnMouseDown)return;let t=f_(e);function n(){e.type===`pointerdown`?A(e):E(e),t?.removeEventListener(e.type,n)}t?.addEventListener(e.type,n)}function re(e){if(!y.current)return;let n=b.current;if(d(),f()===`intentional`){if(e.type===`pointercancel`){n&&u();return}if(!h(e)){if(n){u();return}typeof g==`function`&&!g(e)||(t.clear(),x.current=!0,D())}}}function ie(e){if(f()!==`sloppy`||!w.current||p_(e,n.select(`floatingElement`))||p_(e,n.select(`domReferenceElement`)))return;let t=e.touches[0];if(!t)return;let r=Math.abs(t.clientX-w.current.startX),i=Math.abs(t.clientY-w.current.startY),a=Math.sqrt(r*r+i*i);a>5&&(w.current.dismissOnTouchEnd=!0),a>10&&(E(e),T.clear(),w.current=null)}function ae(e){let t=f_(e);function n(){ie(e),t?.removeEventListener(e.type,n)}t?.addEventListener(e.type,n)}function M(e){f()!==`sloppy`||!w.current||p_(e,n.select(`floatingElement`))||p_(e,n.select(`domReferenceElement`))||(w.current.dismissOnTouchEnd&&E(e),T.clear(),w.current=null)}function N(e){let t=f_(e);function n(){M(e),t?.removeEventListener(e.type,n)}t?.addEventListener(e.type,n)}let P=nv(i);return s&&(P.addEventListener(`keydown`,j),P.addEventListener(`compositionstart`,c),P.addEventListener(`compositionend`,l)),_&&(P.addEventListener(`click`,ne,!0),P.addEventListener(`pointerdown`,ne,!0),P.addEventListener(`pointerup`,re,!0),P.addEventListener(`pointercancel`,re,!0),P.addEventListener(`mousedown`,ne,!0),P.addEventListener(`mouseup`,re,!0),P.addEventListener(`touchstart`,te,!0),P.addEventListener(`touchmove`,ae,!0),P.addEventListener(`touchend`,N,!0)),()=>{s&&(P.removeEventListener(`keydown`,j),P.removeEventListener(`compositionstart`,c),P.removeEventListener(`compositionend`,l)),_&&(P.removeEventListener(`click`,ne,!0),P.removeEventListener(`pointerdown`,ne,!0),P.removeEventListener(`pointerup`,re,!0),P.removeEventListener(`pointercancel`,re,!0),P.removeEventListener(`mousedown`,ne,!0),P.removeEventListener(`mouseup`,re,!0),P.removeEventListener(`touchstart`,te,!0),P.removeEventListener(`touchmove`,ae,!0),P.removeEventListener(`touchend`,N,!0)),e.clear(),t.clear(),d(),x.current=!1}},[a,i,s,_,g,r,o,S,C,j,D,v,m,n,T]),z(D,[g,D]);let te=V(()=>({onKeyDown:j,[ny[d]]:e=>{A()&&n.setOpen(!1,zg(Ng,e.nativeEvent))},...d!==`intentional`&&{onClick(e){A()&&n.setOpen(!1,zg(`trigger-press`,e.nativeEvent))}}}),[j,n,d,A]),ne=Q(e=>{if(!r||!o||e.button!==0)return;let t=f_(e.nativeEvent);d_(n.select(`floatingElement`),t)&&(y.current||(y.current=!0,b.current=!1))}),re=Q(e=>{!r||!o||(e.defaultPrevented||e.nativeEvent.defaultPrevented)&&y.current&&(b.current=!0)}),ie=V(()=>({onKeyDown:j,onPointerDown:re,onMouseDown:re,onClickCapture:ee,onMouseDownCapture(e){ee(),ne(e)},onPointerDownCapture(e){ee(),ne(e)},onMouseUpCapture:ee,onTouchEndCapture:ee,onTouchMoveCapture:ee}),[j,ee,ne,re]);return V(()=>o?{reference:te,floating:ie,trigger:te}:{},[o,te,ie])}var oy=Symbol(`NOT_FOUND`);function sy(e,t=`expected a function, instead received ${typeof e}`){if(typeof e!=`function`)throw TypeError(t)}function cy(e,t=`expected an object, instead received ${typeof e}`){if(typeof e!=`object`)throw TypeError(t)}function ly(e,t=`expected all items to be functions, instead received the following types: `){if(!e.every(e=>typeof e==`function`)){let n=e.map(e=>typeof e==`function`?`function ${e.name||`unnamed`}()`:typeof e).join(`, `);throw TypeError(`${t}[${n}]`)}}var uy=e=>Array.isArray(e)?e:[e];function dy(e){let t=Array.isArray(e[0])?e[0]:e;return ly(t,`createSelector expects all input-selectors to be functions, but received the following types: `),t}function fy(e,t){let n=[],{length:r}=e;for(let i=0;i<r;i++)n.push(e[i].apply(null,t));return n}function py(e){let t;return{get(n){return t&&e(t.key,n)?t.value:oy},put(e,n){t={key:e,value:n}},getEntries(){return t?[t]:[]},clear(){t=void 0}}}function my(e,t){let n=[];function r(e){let r=n.findIndex(n=>t(e,n.key));if(r>-1){let e=n[r];return r>0&&(n.splice(r,1),n.unshift(e)),e.value}return oy}function i(t,i){r(t)===oy&&(n.unshift({key:t,value:i}),n.length>e&&n.pop())}function a(){return n}function o(){n=[]}return{get:r,put:i,getEntries:a,clear:o}}var hy=(e,t)=>e===t;function gy(e){return function(t,n){if(t===null||n===null||t.length!==n.length)return!1;let{length:r}=t;for(let i=0;i<r;i++)if(!e(t[i],n[i]))return!1;return!0}}function _y(e,t){let{equalityCheck:n=hy,maxSize:r=1,resultEqualityCheck:i}=typeof t==`object`?t:{equalityCheck:t},a=gy(n),o=0,s=r<=1?py(a):my(r,a);function c(){let t=s.get(arguments);if(t===oy){if(t=e.apply(null,arguments),o++,i){let e=s.getEntries().find(e=>i(e.value,t));e&&(t=e.value,o!==0&&o--)}s.put(arguments,t)}return t}return c.clearCache=()=>{s.clear(),c.resetResultsCount()},c.resultsCount=()=>o,c.resetResultsCount=()=>{o=0},c}var vy=class{constructor(e){this.value=e}deref(){return this.value}},yy=typeof WeakRef<`u`?WeakRef:vy,by=0,xy=1;function Sy(){return{s:by,v:void 0,o:null,p:null}}function Cy(e,t={}){let n=Sy(),{resultEqualityCheck:r}=t,i,a=0;function o(){let t=n,{length:o}=arguments;for(let e=0,n=o;e<n;e++){let n=arguments[e];if(typeof n==`function`||typeof n==`object`&&n){let e=t.o;e===null&&(t.o=e=new WeakMap);let r=e.get(n);r===void 0?(t=Sy(),e.set(n,t)):t=r}else{let e=t.p;e===null&&(t.p=e=new Map);let r=e.get(n);r===void 0?(t=Sy(),e.set(n,t)):t=r}}let s=t,c;if(t.s===xy)c=t.v;else if(c=e.apply(null,arguments),a++,r){let e=i?.deref?.()??i;e!=null&&r(e,c)&&(c=e,a!==0&&a--),i=typeof c==`object`&&c||typeof c==`function`?new yy(c):c}return s.s=xy,s.v=c,c}return o.clearCache=()=>{n=Sy(),o.resetResultsCount()},o.resultsCount=()=>a,o.resetResultsCount=()=>{a=0},o}function wy(e,...t){let n=typeof e==`function`?{memoize:e,memoizeOptions:t}:e,r=(...e)=>{let t=0,r=0,i,a={},o=e.pop();typeof o==`object`&&(a=o,o=e.pop()),sy(o,`createSelector expects an output function after the inputs, but received: [${typeof o}]`);let{memoize:s,memoizeOptions:c=[],argsMemoize:l=Cy,argsMemoizeOptions:u=[],devModeChecks:d={}}={...n,...a},f=uy(c),p=uy(u),m=dy(e),h=s(function(){return t++,o.apply(null,arguments)},...f),g=l(function(){r++;let e=fy(m,arguments);return i=h.apply(null,e),i},...p);return Object.assign(g,{resultFunc:o,memoizedResultFunc:h,dependencies:m,dependencyRecomputations:()=>r,resetDependencyRecomputations:()=>{r=0},lastResult:()=>i,recomputations:()=>t,resetRecomputations:()=>{t=0},memoize:s,argsMemoize:l})};return Object.assign(r,{withTypes:()=>r}),r}var Ty=wy(Cy),Ey=Object.assign((e,t=Ty)=>{cy(e,`createStructuredSelector expects first argument to be an object where each property is a selector, instead received a ${typeof e}`);let n=Object.keys(e);return t(n.map(t=>e[t]),(...e)=>e.reduce((e,t,r)=>(e[n[r]]=t,e),{}))},{withTypes:()=>Ey});wy({memoize:_y,memoizeOptions:{maxSize:1,equalityCheck:Object.is}});var Dy=(e,t,n,r,i,a,...o)=>{if(o.length>0)throw Error(hh(1));let s;if(e&&t&&n&&r&&i&&a)s=(o,s,c,l)=>a(e(o,s,c,l),t(o,s,c,l),n(o,s,c,l),r(o,s,c,l),i(o,s,c,l),s,c,l);else if(e&&t&&n&&r&&i)s=(a,o,s,c)=>i(e(a,o,s,c),t(a,o,s,c),n(a,o,s,c),r(a,o,s,c),o,s,c);else if(e&&t&&n&&r)s=(i,a,o,s)=>r(e(i,a,o,s),t(i,a,o,s),n(i,a,o,s),a,o,s);else if(e&&t&&n)s=(r,i,a,o)=>n(e(r,i,a,o),t(r,i,a,o),i,a,o);else if(e&&t)s=(n,r,i,a)=>t(e(n,r,i,a),r,i,a);else if(e)s=e;else throw Error(`Missing arguments`);return s},Oy=s((e=>{var t=(Z(),d(pm));function n(e,t){return e===t&&(e!==0||1/e==1/t)||e!==e&&t!==t}var r=typeof Object.is==`function`?Object.is:n,i=t.useState,a=t.useEffect,o=t.useLayoutEffect,s=t.useDebugValue;function c(e,t){var n=t(),r=i({inst:{value:n,getSnapshot:t}}),c=r[0].inst,u=r[1];return o(function(){c.value=n,c.getSnapshot=t,l(c)&&u({inst:c})},[e,n,t]),a(function(){return l(c)&&u({inst:c}),e(function(){l(c)&&u({inst:c})})},[e]),s(n),n}function l(e){var t=e.getSnapshot;e=e.value;try{var n=t();return!r(e,n)}catch{return!0}}function u(e,t){return t()}var f=typeof window>`u`||window.document===void 0||window.document.createElement===void 0?u:c;e.useSyncExternalStore=t.useSyncExternalStore===void 0?f:t.useSyncExternalStore})),ky=s(((e,t)=>{t.exports=Oy()})),Ay=s((e=>{var t=(Z(),d(pm)),n=ky();function r(e,t){return e===t&&(e!==0||1/e==1/t)||e!==e&&t!==t}var i=typeof Object.is==`function`?Object.is:r,a=n.useSyncExternalStore,o=t.useRef,s=t.useEffect,c=t.useMemo,l=t.useDebugValue;e.useSyncExternalStoreWithSelector=function(e,t,n,r,u){var d=o(null);if(d.current===null){var f={hasValue:!1,value:null};d.current=f}else f=d.current;d=c(function(){function e(e){if(!a){if(a=!0,o=e,e=r(e),u!==void 0&&f.hasValue){var t=f.value;if(u(t,e))return s=t}return s=e}if(t=s,i(o,e))return t;var n=r(e);return u!==void 0&&u(t,n)?(o=e,t):(o=e,s=n)}var a=!1,o,s,c=n===void 0?null:n;return[function(){return e(t())},c===null?void 0:function(){return e(c())}]},[t,n,r,u]);var p=a(e,d[0],d[1]);return s(function(){f.hasValue=!0,f.value=p},[p]),l(p),p}})),jy=s(((e,t)=>{t.exports=Ay()}));Z();var My=[],Ny=void 0;function Py(){return Ny}function Fy(e){My.push(e)}Z();var Iy=ky(),Ly=jy(),Ry=Dh(19)?Vy:Hy;function zy(e,t,n,r,i){return Ry(e,t,n,r,i)}function By(e,t,n,r,i){let a=H(()=>t(e.getSnapshot(),n,r,i),[e,t,n,r,i]);return(0,Iy.useSyncExternalStore)(e.subscribe,a,a)}Fy({before(e){e.syncIndex=0,e.didInitialize||(e.syncTick=1,e.syncHooks=[],e.didChangeStore=!0,e.getSnapshot=()=>{let t=!1;for(let n=0;n<e.syncHooks.length;n+=1){let r=e.syncHooks[n],i=r.selector(r.store.state,r.a1,r.a2,r.a3);(r.didChange||!Object.is(r.value,i))&&(t=!0,r.value=i,r.didChange=!1)}return t&&(e.syncTick+=1),e.syncTick})},after(e){e.syncHooks.length>0&&(e.didChangeStore&&(e.didChangeStore=!1,e.subscribe=t=>{let n=new Set;for(let t of e.syncHooks)n.add(t.store);let r=[];for(let e of n)r.push(e.subscribe(t));return()=>{for(let e of r)e()}}),(0,Iy.useSyncExternalStore)(e.subscribe,e.getSnapshot,e.getSnapshot))}});function Vy(e,t,n,r,i){let a=Py();if(!a)return By(e,t,n,r,i);let o=a.syncIndex;a.syncIndex+=1;let s;return a.didInitialize?(s=a.syncHooks[o],(s.store!==e||s.selector!==t||!Object.is(s.a1,n)||!Object.is(s.a2,r)||!Object.is(s.a3,i))&&(s.store!==e&&(a.didChangeStore=!0),s.store=e,s.selector=t,s.a1=n,s.a2=r,s.a3=i,s.didChange=!0)):(s={store:e,selector:t,a1:n,a2:r,a3:i,value:t(e.getSnapshot(),n,r,i),didChange:!1},a.syncHooks.push(s)),s.value}function Hy(e,t,n,r,i){return(0,Ly.useSyncExternalStoreWithSelector)(e.subscribe,e.getSnapshot,e.getSnapshot,e=>t(e,n,r,i))}var Uy=class{constructor(e){this.state=e,this.listeners=new Set,this.updateTick=0}subscribe=e=>(this.listeners.add(e),()=>{this.listeners.delete(e)});getSnapshot=()=>this.state;setState(e){if(this.state===e)return;this.state=e,this.updateTick+=1;let t=this.updateTick;for(let n of this.listeners){if(t!==this.updateTick)return;n(e)}}update(e){for(let t in e)if(!Object.is(this.state[t],e[t])){this.setState({...this.state,...e});return}}set(e,t){Object.is(this.state[e],t)||this.setState({...this.state,[e]:t})}notifyAll(){let e={...this.state};this.setState(e)}use(e,t,n,r){return zy(this,e,t,n,r)}};Z();var Wy=class extends Uy{constructor(e,t={},n){super(e),this.context=t,this.selectors=n}useSyncedValue(e,t){Ae(e),Mg(()=>{this.state[e]!==t&&this.set(e,t)},[e,t])}useSyncedValueWithCleanup(e,t){let n=this;Mg(()=>(n.state[e]!==t&&n.set(e,t),()=>{n.set(e,void 0)}),[n,e,t])}useSyncedValues(e){let t=this;Mg(()=>{t.update(e)},[t,...Object.values(e)])}useControlledProp(e,t){Ae(e);let n=t!==void 0;Mg(()=>{n&&!Object.is(this.state[e],t)&&super.setState({...this.state,[e]:t})},[e,t,n])}select(e,t,n,r){let i=this.selectors[e];return i(this.state,t,n,r)}useState(e,t,n,r){return Ae(e),zy(this,this.selectors[e],t,n,r)}useContextCallback(e,t){Ae(e);let n=Q(t??Gh);this.context[e]=n}useStateSetter(e){let t=B(void 0);return t.current===void 0&&(t.current=t=>{this.set(e,t)}),t.current}observe(e,t){let n;n=typeof e==`function`?e:this.selectors[e];let r=n(this.state);return t(r,r,this),this.subscribe(e=>{let i=n(e);if(!Object.is(r,i)){let e=r;r=i,t(i,e,this)}})}},Gy={open:Dy(e=>e.open),domReferenceElement:Dy(e=>e.domReferenceElement),referenceElement:Dy(e=>e.positionReference??e.referenceElement),floatingElement:Dy(e=>e.floatingElement),floatingId:Dy(e=>e.floatingId)},Ky=class extends Wy{constructor(e){let{nested:t,noEmit:n,onOpenChange:r,triggerElements:i,...a}=e;super({...a,positionReference:a.referenceElement,domReferenceElement:a.referenceElement},{onOpenChange:r,dataRef:{current:{}},events:Bv(),nested:t,noEmit:n,triggerElements:i},Gy)}setOpen=(e,t)=>{if((!e||!this.state.open||w_(t.event))&&(this.context.dataRef.current.openEvent=e?t.event:void 0),!this.context.noEmit){let n={open:e,reason:t.reason,nativeEvent:t.event,nested:this.context.nested,triggerElement:t.trigger};this.context.events.emit(`openchange`,n)}this.context.onOpenChange?.(e,t)}};Z();function qy(e,t=!1,n=!1){let[r,i]=R(e&&t?`idle`:void 0),[a,o]=R(e);return e&&!a&&(o(!0),i(`starting`)),!e&&a&&r!==`ending`&&!n&&i(`ending`),!e&&!a&&r===`ending`&&i(void 0),Mg(()=>{if(!e&&a&&r!==`ending`&&n){let e=hv.request(()=>{i(`ending`)});return()=>{hv.cancel(e)}}},[e,a,r,n]),Mg(()=>{if(!e||t)return;let n=hv.request(()=>{i(void 0)});return()=>{hv.cancel(n)}},[t,e]),Mg(()=>{if(!e||!t)return;e&&a&&r!==`idle`&&i(`starting`);let n=hv.request(()=>{i(`idle`)});return()=>{hv.cancel(n)}},[t,e,a,i,r]),V(()=>({mounted:a,setMounted:o,transitionStatus:r}),[a,r])}Z();function Jy(e,t=!1,n=!0){let r=gv();return Q((i,a=null)=>{r.cancel();function o(){dh(i)}let s=Gv(e);if(s==null)return;let c=s;if(typeof c.getAnimations!=`function`||globalThis.BASE_UI_ANIMATIONS_DISABLED)i();else{function e(){let e=$h.startingStyle;if(!c.hasAttribute(e)){r.request(i);return}let t=new MutationObserver(()=>{c.hasAttribute(e)||(t.disconnect(),i())});t.observe(c,{attributes:!0,attributeFilter:[e]}),a?.addEventListener(`abort`,()=>t.disconnect(),{once:!0})}function i(){Promise.all(c.getAnimations().map(e=>e.finished)).then(()=>{a?.aborted||o()}).catch(()=>{let e=c.getAnimations();if(n){if(a?.aborted)return;o()}else e.length>0&&e.some(e=>e.pending||e.playState!==`finished`)&&i()})}if(t){e();return}r.request(i)}})}Z();function Yy(e){let{enabled:t=!0,open:n,ref:r,onComplete:i}=e,a=Q(i),o=Jy(r,n,!1);z(()=>{if(!t)return;let e=new AbortController;return o(a,e.signal),()=>{e.abort()}},[t,n,a,o])}Z();function Xy(e){let t=e.useState(`open`);Mg(()=>{if(t&&!e.select(`activeTriggerId`)&&e.context.triggerElements.size===1){let t=e.context.triggerElements.entries().next();if(!t.done){let[n,r]=t.value;e.update({activeTriggerId:n,activeTriggerElement:r})}}},[t,e])}function Zy(e,t,n){let{mounted:r,setMounted:i,transitionStatus:a}=qy(e);t.useSyncedValues({mounted:r,transitionStatus:a});let o=Q(()=>{i(!1),t.update({activeTriggerId:null,activeTriggerElement:null,mounted:!1}),n?.(),t.context.onOpenChangeComplete?.(!1)});return Yy({enabled:!t.useState(`preventUnmountingOnClose`),open:e,ref:t.context.popupRef,onComplete(){e||o()}}),{forceUnmount:o,transitionStatus:a}}var Qy=class{constructor(){this.elementsSet=new Set,this.idMap=new Map}add(e,t){let n=this.idMap.get(e);n!==t&&(n!==void 0&&this.elementsSet.delete(n),this.elementsSet.add(t),this.idMap.set(e,t))}delete(e){let t=this.idMap.get(e);t&&(this.elementsSet.delete(t),this.idMap.delete(e))}hasElement(e){return this.elementsSet.has(e)}hasMatchingElement(e){for(let t of this.elementsSet)if(e(t))return!0;return!1}getById(e){return this.idMap.get(e)}entries(){return this.idMap.entries()}elements(){return this.elementsSet.values()}get size(){return this.idMap.size}};function $y(){return new Ky({open:!1,floatingElement:null,referenceElement:null,triggerElements:new Qy,floatingId:``,nested:!1,noEmit:!1,onOpenChange:void 0})}function eb(){return{open:!1,openProp:void 0,mounted:!1,transitionStatus:`idle`,floatingRootContext:$y(),preventUnmountingOnClose:!1,payload:void 0,activeTriggerId:null,activeTriggerElement:null,triggerIdProp:void 0,popupElement:null,positionerElement:null,activeTriggerProps:Kh,inactiveTriggerProps:Kh,popupProps:Kh}}var tb=Dy(e=>e.triggerIdProp??e.activeTriggerId),nb={open:Dy(e=>e.openProp??e.open),mounted:Dy(e=>e.mounted),transitionStatus:Dy(e=>e.transitionStatus),floatingRootContext:Dy(e=>e.floatingRootContext),preventUnmountingOnClose:Dy(e=>e.preventUnmountingOnClose),payload:Dy(e=>e.payload),activeTriggerId:tb,activeTriggerElement:Dy(e=>e.mounted?e.activeTriggerElement:null),isTriggerActive:Dy((e,t)=>t!==void 0&&tb(e)===t),isOpenedByTrigger:Dy((e,t)=>t!==void 0&&tb(e)===t&&e.open),isMountedByTrigger:Dy((e,t)=>t!==void 0&&tb(e)===t&&e.mounted),triggerProps:Dy((e,t)=>t?e.activeTriggerProps:e.inactiveTriggerProps),popupProps:Dy(e=>e.popupProps),popupElement:Dy(e=>e.popupElement),positionerElement:Dy(e=>e.positionerElement)};function rb(e){let{popupStore:t,noEmit:n=!1,treatPopupAsFloatingElement:r=!1,onOpenChange:i}=e,a=Ug(),o=Uv()!=null,s=t.useState(`open`),c=t.useState(`activeTriggerElement`),l=t.useState(r?`popupElement`:`positionerElement`),u=t.context.triggerElements,d=yh(()=>new Ky({open:s,referenceElement:c,floatingElement:l,triggerElements:u,onOpenChange:i,floatingId:a,nested:o,noEmit:n})).current;return Mg(()=>{let e={open:s,floatingId:a,referenceElement:c,floatingElement:l};vg(c)&&(e.domReferenceElement=c),d.state.positionReference===d.state.referenceElement&&(e.positionReference=c),d.update(e)},[s,a,c,l,d]),d.context.onOpenChange=i,d.context.nested=o,d.context.noEmit=n,d}Z();function ib(e=[]){let t=e.map(e=>e?.reference),n=e.map(e=>e?.floating),r=e.map(e=>e?.item),i=e.map(e=>e?.trigger),a=H(t=>ab(t,e,`reference`),t),o=H(t=>ab(t,e,`floating`),n),s=H(t=>ab(t,e,`item`),r),c=H(t=>ab(t,e,`trigger`),i);return V(()=>({getReferenceProps:a,getFloatingProps:o,getItemProps:s,getTriggerProps:c}),[a,o,s,c])}function ab(e,t,n){let r=new Map,i=n===`item`,a={};n===`floating`&&(a.tabIndex=-1,a[l_]=``);for(let t in e)i&&e&&(t===`active`||t===`selected`)||(a[t]=e[t]);for(let o=0;o<t.length;o+=1){let s,c=t[o]?.[n];s=typeof c==`function`?e?c(e):null:c,s&&ob(a,s,i,r)}return ob(a,e,i,r),a}function ob(e,t,n,r){for(let i in t){let a=t[i];n&&(i===`active`||i===`selected`)||(i.startsWith(`on`)?(r.has(i)||r.set(i,[]),typeof a==`function`&&(r.get(i)?.push(a),e[i]=(...e)=>r.get(i)?.map(t=>t(...e)).find(e=>e!==void 0))):e[i]=a)}}Z();var sb=new Map([[`select`,`listbox`],[`combobox`,`listbox`],[`label`,!1]]);function cb(e,t={}){let n=`rootStore`in e?e.rootStore:e,r=n.useState(`open`),i=n.useState(`floatingId`),a=n.useState(`domReferenceElement`),o=n.useState(`floatingElement`),{role:s=`dialog`}=t,c=Ug(),l=a?.id||c,u=V(()=>__(o)?.id||i,[o,i]),d=sb.get(s)??s,f=Uv()!=null,p=V(()=>d===`tooltip`||s===`label`?Kh:{"aria-haspopup":d===`alertdialog`?`dialog`:d,"aria-expanded":`false`,...d===`listbox`&&{role:`combobox`},...d===`menu`&&f&&{role:`menuitem`},...s===`select`&&{"aria-autocomplete":`none`},...s===`combobox`&&{"aria-autocomplete":`list`}},[d,f,s]),m=V(()=>d===`tooltip`||s===`label`?{[`aria-${s===`label`?`labelledby`:`describedby`}`]:r?u:void 0}:{...p,"aria-expanded":r?`true`:`false`,"aria-controls":r?u:void 0,...d===`menu`&&{id:l}},[d,u,r,l,s,p]),h=V(()=>{let e={id:u,...d&&{role:d}};return d===`tooltip`||s===`label`?e:{...e,...d===`menu`&&{"aria-labelledby":l}}},[d,u,l,s]),g=H(({active:e,selected:t})=>{let n={role:`option`,...e&&{id:`${u}-fui-option`}};switch(s){case`select`:case`combobox`:return{...n,"aria-selected":t};default:}return{}},[u,s]);return V(()=>({reference:m,floating:h,item:g,trigger:p}),[m,h,p,g])}var lb=function(e){return e[e.open=rg.open]=`open`,e[e.closed=rg.closed]=`closed`,e[e.startingStyle=rg.startingStyle]=`startingStyle`,e[e.endingStyle=rg.endingStyle]=`endingStyle`,e.expanded=`data-expanded`,e.nestedDrawerOpen=`data-nested-drawer-open`,e.nestedDrawerSwiping=`data-nested-drawer-swiping`,e.swipeDismiss=`data-swipe-dismiss`,e.swipeDirection=`data-swipe-direction`,e.swiping=`data-swiping`,e}({});Z();var ub=ce(void 0);function db(){let e=ke(ub);if(e===void 0)throw Error(hh(26));return e}var fb=`ArrowUp`,pb=`ArrowDown`,mb=`ArrowLeft`,hb=`ArrowRight`,gb=`Home`,_b=new Set([mb,hb]),vb=new Set([fb,pb]),yb=new Set([..._b,...vb]);new Set([...yb,gb,`End`]);var bb=new Set([fb,pb,mb,hb,gb,`End`]);Z();var xb=ce(void 0);function Sb(e){let t=ke(xb);if(e===!1&&t===void 0)throw Error(hh(90));return t}function Cb(e,t=-(2**53-1),n=2**53-1){return Math.max(t,Math.min(e,n))}Z();function wb(e,t,n){if(!Number.isFinite(t)||t<=0)return null;if(typeof e==`number`)return Number.isFinite(e)?e<=1?Cb(e,0,1)*t:e:null;let r=e.trim();if(r.endsWith(`px`)){let e=Number.parseFloat(r);return Number.isFinite(e)?e:null}if(r.endsWith(`rem`)){let e=Number.parseFloat(r);return Number.isFinite(e)?e*n:null}return null}function Tb(e,t){let n=null,r=1/0;for(let i of t){let t=Math.abs(i.height-e);t<r&&(r=t,n=i)}return n}function Eb(){let{store:e}=_h(),{snapPoints:t,activeSnapPoint:n,setActiveSnapPoint:r,popupHeight:i}=Sb(),a=e.useState(`viewportElement`),[o,s]=R(0),[c,l]=R(16),u=Q(()=>{let e=nv(a).documentElement;a&&s(a.offsetHeight),a||s(e.clientHeight);let t=parseFloat(getComputedStyle(e).fontSize);Number.isFinite(t)&&l(t)});Mg(()=>{if(u(),!a||typeof ResizeObserver!=`function`)return;let e=new ResizeObserver(u);return e.observe(a),()=>{e.disconnect()}},[u,a]);let d=V(()=>{if(!t||t.length===0||o<=0||i<=0)return[];let e=Math.min(i,o);if(!Number.isFinite(e)||e<=0)return[];let n=t.map(t=>{let n=wb(t,o,c);if(n===null||!Number.isFinite(n))return null;let r=Cb(n,0,e);return{value:t,height:r,offset:Math.max(0,i-r)}}).filter(e=>!!e);if(n.length<=1)return n;let r=[],a=[];for(let e=n.length-1;e>=0;--e){let t=n[e];a.some(e=>Math.abs(e-t.height)<=1)||(a.push(t.height),r.push(t))}return r.reverse(),r},[i,c,t,o]);return{snapPoints:t,activeSnapPoint:n,setActiveSnapPoint:r,popupHeight:i,viewportHeight:o,resolvedSnapPoints:d,activeSnapPointOffset:V(()=>{if(n===void 0)return d[0];if(n===null)return;let e=d.find(e=>Object.is(e.value,n));if(e)return e;let t=Math.min(i,o),r=wb(n,o,c);if(!(r===null||!Number.isFinite(r)))return Tb(Cb(r,0,t),d)??void 0},[n,i,d,c,o])?.offset??null}}Z();var Db=ce(null);function Ob(e){let t=ke(Db);if(e===!1&&t===null)throw Error(hh(92));return t}Z();var kb=!1;function Ab(){kb||=(typeof CSS<`u`&&`registerProperty`in CSS&&([lg.swipeMovementX,lg.swipeMovementY,lg.snapPointOffset].forEach(e=>{try{CSS.registerProperty({name:e,syntax:`<length>`,inherits:!1,initialValue:`0px`})}catch{}}),[{name:ug.swipeProgress,initialValue:`0`},{name:lg.swipeStrength,initialValue:`1`}].forEach(({name:e,initialValue:t})=>{try{CSS.registerProperty({name:e,syntax:`<number>`,inherits:!1,initialValue:t})}catch{}})),!0)}var jb={...cg,...ng,expanded(e){return e?{[lb.expanded]:``}:null},nestedDrawerOpen(e){return e?{[lb.nestedDrawerOpen]:``}:null},nestedDrawerSwiping(e){return e?{[lb.nestedDrawerSwiping]:``}:null},swipeDirection(e){return e?{[lb.swipeDirection]:e}:null},swiping(e){return e?{[lb.swiping]:``}:null}},Mb=Cm(function(e,t){let{className:n,finalFocus:r,initialFocus:i,render:a,...o}=e,{store:s}=_h(),{swipeDirection:c,frontmostHeight:l,hasNestedDrawer:u,nestedSwiping:d,nestedSwipeProgressStore:f,onPopupHeightChange:p,notifyParentFrontmostHeight:m,notifyParentHasNestedDrawer:h}=Sb(),g=s.useState(`descriptionElementId`),_=s.useState(`disablePointerDismissal`),v=s.useState(`floatingRootContext`),y=s.useState(`popupProps`),b=s.useState(`modal`),x=s.useState(`mounted`),S=s.useState(`nested`),C=s.useState(`nestedOpenDialogCount`),w=s.useState(`transitionStatus`),T=s.useState(`open`),E=s.useState(`openMethod`),D=s.useState(`titleElementId`),O=s.useState(`role`),k=C>0,A=Ob(!0),j=A?.swiping??!1,ee=A?.swipeStrength??null,{snapPoints:te,activeSnapPoint:ne,activeSnapPointOffset:re}=Eb();db();let[ie,ae]=R(0),M=B(0),N=Q(()=>{let e=s.context.popupRef.current;if(!e)return;let t=e.offsetHeight;if(M.current>0&&l>M.current&&t>M.current)return;if(M.current>0&&u){let e=M.current;ae(e),p(e);return}let n=t;n!==M.current&&(M.current=n,ae(n),p(n))});Mg(()=>{if(!x){M.current=0,ae(0),p(0);return}let e=s.context.popupRef.current;if(!e||(Ab(),N(),typeof ResizeObserver!=`function`))return;let t=new ResizeObserver(N);return t.observe(e),()=>{t.disconnect()}},[N,x,k,p,s.context.popupRef]),Mg(()=>{let e=s.context.popupRef,t=()=>{let t=e.current;if(!t)return;let n=f.getSnapshot();n>0?t.style.setProperty(ug.swipeProgress,`${n}`):t.style.setProperty(ug.swipeProgress,`0`)};t();let n=f.subscribe(t);return()=>{n();let t=e.current;t&&t.style.setProperty(ug.swipeProgress,`0`)}},[f,s.context.popupRef]),z(()=>{if(T)return m?.(l),()=>{m?.(0)}},[l,T,m]),z(()=>{if(h)return h(T||w===`ending`),()=>{h(!1)}},[h,T,w]),Yy({open:T,ref:s.context.popupRef,onComplete(){T&&s.context.onOpenChangeComplete?.(!0)}});let P=i===void 0?s.context.popupRef:i,F={open:T,nested:S,transitionStatus:w,expanded:ne===1,nestedDrawerOpen:k,nestedDrawerSwiping:d,swipeDirection:c,swiping:j},oe;ie&&!(!u&&w!==`ending`)&&(oe=`${ie}px`);let se=te&&te.length>0&&(c===`down`||c===`up`),ce=null;se&&re!==null&&(ce=c===`up`?-re:re);let I=A?A.getDragStyles():Kh;if(se&&c===`down`){let e=re??0,t=Number.parseFloat(String(I[lg.swipeMovementY]??0)),n=Number.isFinite(t)?e+t:e;if(j&&n<0&&Number.isFinite(t)){let t=Math.abs(n),r=-Math.sqrt(t)-e;I={...I,transform:void 0,[lg.swipeMovementY]:`${r}px`}}else I={...I,transform:void 0}}let L=Jh(`div`,e,{state:F,props:[y,{"aria-labelledby":D,"aria-describedby":g,role:O,tabIndex:-1,hidden:!x,onKeyDown(e){bb.has(e.key)&&e.stopPropagation()},style:{...I,[ug.swipeProgress]:`0`,[lg.nestedDrawers]:C,[lg.height]:oe,[lg.snapPointOffset]:typeof ce==`number`?`${ce}px`:`0px`,[lg.frontmostHeight]:l?`${l}px`:void 0,[lg.swipeStrength]:typeof ee==`number`&&Number.isFinite(ee)&&ee>0?`${ee}`:`1`}},o],ref:[t,s.context.popupRef,s.useStateSetter(`popupElement`)],stateAttributesMapping:jb});return $(ty,{context:v,openInteractionType:E,disabled:!x,closeOnFocusOut:!_,initialFocus:P,returnFocus:r,modal:b!==!1,restoreFocus:`popup`,children:L})});function Nb(e){return Dh(19)?e:e?`true`:void 0}Z();var Pb=Cm(function(e,t){let{cutout:n,...r}=e,i;if(n){let e=n?.getBoundingClientRect();i=`polygon(
      ...
      ${e.right}px ${e.top}px,
      ${e.left}px ${e.top}px
    )`}return $(`div`,{ref:t,role:`presentation`,"data-base-ui-inert":``,...r,style:{position:`fixed`,inset:0,userSelect:`none`,WebkitUserSelect:`none`,clipPath:i}})});Z();var Fb=Cm(function(e,t){let{keepMounted:n=!1,...r}=e,{store:i}=_h(),a=i.useState(`mounted`),o=i.useState(`modal`),s=i.useState(`open`);return a||n?$(ub.Provider,{value:n,children:$(zv,{ref:t,...r,children:[a&&o===!0&&$(Pb,{ref:i.context.internalBackdropRef,inert:Nb(!s)}),e.children]})}):null});Z();function Ib({controlled:e,default:t,name:n,state:r=`value`}){let{current:i}=B(e!==void 0),[a,o]=R(t);return[i?e:a,H(e=>{i||o(e)},[])]}Z();function Lb(e){let t=B(!0);t.current&&(t.current=!1,e())}var Rb={},zb={},Bb=``;function Vb(e){if(typeof document>`u`)return!1;let t=nv(e);return hg(t).innerWidth-t.documentElement.clientWidth>0}function Hb(e){if(!(typeof CSS<`u`&&CSS.supports&&CSS.supports(`scrollbar-gutter`,`stable`))||typeof document>`u`)return!1;let t=nv(e),n=t.documentElement,r=t.body,i=xg(n)?n:r,a=i.style.overflowY,o=n.style.scrollbarGutter;n.style.scrollbarGutter=`stable`,i.style.overflowY=`scroll`;let s=i.offsetWidth;i.style.overflowY=`hidden`;let c=i.offsetWidth;return i.style.overflowY=a,n.style.scrollbarGutter=o,s===c}function Ub(e){let t=nv(e),n=t.documentElement,r=t.body,i=xg(n)?n:r,a={overflowY:i.style.overflowY,overflowX:i.style.overflowX};return Object.assign(i.style,{overflowY:`hidden`,overflowX:`hidden`}),()=>{Object.assign(i.style,a)}}function Wb(e){let t=nv(e),n=t.documentElement,r=t.body,i=hg(n),a=0,o=0,s=!1,c=hv.create();if(t_&&(i.visualViewport?.scale??1)!==1)return()=>{};function l(){let t=i.getComputedStyle(n),c=i.getComputedStyle(r),l=(t.scrollbarGutter||``).includes(`both-edges`)?`stable both-edges`:`stable`;a=n.scrollTop,o=n.scrollLeft,Rb={scrollbarGutter:n.style.scrollbarGutter,overflowY:n.style.overflowY,overflowX:n.style.overflowX},Bb=n.style.scrollBehavior,zb={position:r.style.position,height:r.style.height,width:r.style.width,boxSizing:r.style.boxSizing,overflowY:r.style.overflowY,overflowX:r.style.overflowX,scrollBehavior:r.style.scrollBehavior};let u=n.scrollHeight>n.clientHeight,d=n.scrollWidth>n.clientWidth,f=t.overflowY===`scroll`||c.overflowY===`scroll`,p=t.overflowX===`scroll`||c.overflowX===`scroll`,m=Math.max(0,i.innerWidth-r.clientWidth),h=Math.max(0,i.innerHeight-r.clientHeight),g=parseFloat(c.marginTop)+parseFloat(c.marginBottom),_=parseFloat(c.marginLeft)+parseFloat(c.marginRight),v=xg(n)?n:r;if(s=Hb(e),s){n.style.scrollbarGutter=l,v.style.overflowY=`hidden`,v.style.overflowX=`hidden`;return}Object.assign(n.style,{scrollbarGutter:l,overflowY:`hidden`,overflowX:`hidden`}),(u||f)&&(n.style.overflowY=`scroll`),(d||p)&&(n.style.overflowX=`scroll`),Object.assign(r.style,{position:`relative`,height:g||h?`calc(100dvh - ${g+h}px)`:`100dvh`,width:_||m?`calc(100vw - ${_+m}px)`:`100vw`,boxSizing:`border-box`,overflow:`hidden`,scrollBehavior:`unset`}),r.scrollTop=a,r.scrollLeft=o,n.setAttribute(`data-base-ui-scroll-locked`,``),n.style.scrollBehavior=`unset`}function u(){Object.assign(n.style,Rb),Object.assign(r.style,zb),s||(n.scrollTop=a,n.scrollLeft=o,n.removeAttribute(`data-base-ui-scroll-locked`),n.style.scrollBehavior=Bb)}function d(){u(),c.request(l)}return l(),i.addEventListener(`resize`,d),()=>{c.cancel(),u(),typeof i.removeEventListener==`function`&&i.removeEventListener(`resize`,d)}}var Gb=new class{lockCount=0;restore=null;timeoutLock=Yg.create();timeoutUnlock=Yg.create();acquire(e){return this.lockCount+=1,this.lockCount===1&&this.restore===null&&this.timeoutLock.start(0,()=>this.lock(e)),this.release}release=()=>{--this.lockCount,this.lockCount===0&&this.restore&&this.timeoutUnlock.start(0,this.unlock)};unlock=()=>{this.lockCount===0&&this.restore&&(this.restore?.(),this.restore=null)};lock(e){if(this.lockCount===0||this.restore!==null)return;let t=nv(e).documentElement,n=hg(t).getComputedStyle(t).overflowY;if(n===`hidden`||n===`clip`){this.restore=Gh;return}this.restore=n_||!Vb(e)?Ub(e):Wb(e)}};function Kb(e=!0,t=null){Mg(()=>{if(e)return Gb.acquire(t)},[e,t])}Z();function qb(e){let t=B(``),n=H(n=>{n.defaultPrevented||(t.current=n.pointerType,e(n,n.pointerType))},[e]);return{onClick:H(n=>{if(n.detail===0){e(n,`keyboard`);return}`pointerType`in n?e(n,n.pointerType):e(n,t.current),t.current=``},[e]),onPointerDown:n}}Z();function Jb(e,t){let n=B(e),r=Q(t);Mg(()=>{n.current!==e&&r(n.current)},[e,r]),Mg(()=>{n.current=e},[e])}Z();function Yb(e){let[t,n]=R(null),r=Q((t,r)=>{e||n(r||(n_?`touch`:``))});Jb(e,t=>{t&&!e&&n(null)});let{onClick:i,onPointerDown:a}=qb(r);return V(()=>({openMethod:t,triggerProps:{onClick:i,onPointerDown:a}}),[t,i,a])}Z();function Xb(e){let{store:t,parentContext:n,actionsRef:r}=e,i=t.useState(`open`),a=t.useState(`disablePointerDismissal`),o=t.useState(`modal`),s=t.useState(`popupElement`),{openMethod:c,triggerProps:l}=Yb(i);Xy(t);let{forceUnmount:u}=Zy(i,t),d=Q(e=>{let n=zg(e);return n.preventUnmountOnClose=()=>{t.set(`preventUnmountingOnClose`,!0)},n}),f=H(()=>{t.setOpen(!1,d(Rg))},[t,d]);Oe(r,()=>({unmount:u,close:f}),[u,f]);let p=rb({popupStore:t,onOpenChange:t.setOpen,treatPopupAsFloatingElement:!0,noEmit:!0}),[m,h]=R(0),g=m===0,_=cb(p),v=ay(p,{outsidePressEvent(){return t.context.internalBackdropRef.current||t.context.backdropRef.current?`intentional`:{mouse:o===`trap-focus`?`sloppy`:`intentional`,touch:`sloppy`}},outsidePress(e){if(!t.context.outsidePressEnabledRef.current||`button`in e&&e.button!==0||`touches`in e&&e.touches.length!==1)return!1;let n=f_(e);if(g&&!a){let e=n;return o&&(t.context.internalBackdropRef.current||t.context.backdropRef.current)?t.context.internalBackdropRef.current===e||t.context.backdropRef.current===e||d_(e,s)&&!e?.hasAttribute(`data-base-ui-portal`):!0}return!1},escapeKey:g});Kb(i&&o===!0,s);let{getReferenceProps:y,getFloatingProps:b,getTriggerProps:x}=ib([_,v]);t.useContextCallback(`onNestedDialogOpen`,e=>{h(e+1)}),t.useContextCallback(`onNestedDialogClose`,()=>{h(0)}),z(()=>(n?.onNestedDialogOpen&&i&&n.onNestedDialogOpen(m),n?.onNestedDialogClose&&!i&&n.onNestedDialogClose(),()=>{n?.onNestedDialogClose&&i&&n.onNestedDialogClose()}),[i,n,m]);let S=V(()=>y(l),[y,l]),C=V(()=>x(l),[x,l]),w=V(()=>b(),[b]);t.useSyncedValues({openMethod:c,activeTriggerProps:S,inactiveTriggerProps:C,popupProps:w,floatingRootContext:p,nestedOpenDialogCount:m})}Z();var Zb={...nb,modal:Dy(e=>e.modal),nested:Dy(e=>e.nested),nestedOpenDialogCount:Dy(e=>e.nestedOpenDialogCount),disablePointerDismissal:Dy(e=>e.disablePointerDismissal),openMethod:Dy(e=>e.openMethod),descriptionElementId:Dy(e=>e.descriptionElementId),titleElementId:Dy(e=>e.titleElementId),viewportElement:Dy(e=>e.viewportElement),role:Dy(e=>e.role)},Qb=class extends Wy{constructor(e){super($b(e),{popupRef:_(),backdropRef:_(),internalBackdropRef:_(),outsidePressEnabledRef:{current:!0},triggerElements:new Qy,onOpenChange:void 0,onOpenChangeComplete:void 0},Zb)}setOpen=(e,t)=>{if(t.preventUnmountOnClose=()=>{this.set(`preventUnmountingOnClose`,!0)},!e&&t.trigger==null&&this.state.activeTriggerId!=null&&(t.trigger=this.state.activeTriggerElement??void 0),this.context.onOpenChange?.(e,t),t.isCanceled)return;let n={open:e,nativeEvent:t.event,reason:t.reason,nested:this.state.nested};this.state.floatingRootContext.context.events?.emit(`openchange`,n);let r={open:e},i=t.trigger?.id??null;(i||e)&&(r.activeTriggerId=i,r.activeTriggerElement=t.trigger??null),this.update(r)}};function $b(e={}){return{...eb(),modal:!0,disablePointerDismissal:!1,popupElement:null,viewportElement:null,descriptionElementId:void 0,titleElementId:void 0,openMethod:null,nested:!1,nestedOpenDialogCount:0,role:`dialog`,...e}}Z();function ex(e){let{children:t,open:n,defaultOpen:r=!1,onOpenChange:i,onOpenChangeComplete:a,disablePointerDismissal:o=!1,modal:s=!0,actionsRef:c,handle:l,triggerId:u,defaultTriggerId:d=null}=e,f=_h(!0),p=!!f,m=yh(()=>l?.store??new Qb({open:r,openProp:n,activeTriggerId:d,triggerIdProp:u,modal:s,disablePointerDismissal:o,nested:p})).current;Lb(()=>{n===void 0&&m.state.open===!1&&r===!0&&m.update({open:!0,activeTriggerId:d})}),m.useControlledProp(`openProp`,n),m.useControlledProp(`triggerIdProp`,u),m.useSyncedValues({disablePointerDismissal:o,nested:p,modal:s}),m.useContextCallback(`onOpenChange`,i),m.useContextCallback(`onOpenChangeComplete`,a);let h=m.useState(`payload`);Xb({store:m,actionsRef:c,parentContext:f?.store.context,onOpenChange:i,triggerIdProp:u});let g=V(()=>({store:m}),[m]);return $(gh.Provider,{value:g,children:typeof t==`function`?t({payload:h}):t})}Z();var tx,nx;function rx(e){let{children:t,open:n,defaultOpen:r=!1,onOpenChange:i,onOpenChangeComplete:a,disablePointerDismissal:o=!1,modal:s=!0,actionsRef:c,handle:l,triggerId:u,defaultTriggerId:d=null,swipeDirection:f=`down`,snapToSequentialPoints:p=!1,snapPoints:m,snapPoint:h,defaultSnapPoint:g,onSnapPointChange:_}=e,y=Q(_),b=Sb(!0),x=b?.onNestedSwipeProgressChange,S=b?.onNestedFrontmostHeightChange,C=b?.onNestedSwipingChange,w=b?.onNestedDrawerPresenceChange,[T,E]=R(0),[D,O]=R(0),[k,A]=R(!1),[j,ee]=R(!1),[te]=R(ix),ne=g===void 0?m?.[0]??null:g,re=h!==void 0,[ie,ae]=Ib({controlled:h,default:ne,name:`Drawer`,state:`snapPoint`}),M=B(!1),N=Q((e,t)=>{let n=t??zg(`none`);y?.(e,n),!n.isCanceled&&ae(e)}),P=V(()=>re||!m||m.length===0?ie:ie===null||!m.some(e=>Object.is(e,ie))?ne:ie,[ie,re,ne,m]),F=Q(e=>{E(e),!M.current&&e>0&&O(e)}),oe=Q(e=>{if(e>0){M.current=!0,O(e);return}M.current=!1,T>0&&O(T)}),se=Q(e=>{A(e)}),ce=Q(e=>{te.set(e),x?.(e)}),I=Q(e=>{ee(e),C?.(e)}),L=Q((e,t)=>{i?.(e,t),!t.isCanceled&&!e&&m&&m.length>0&&N(ne,zg(t.reason,t.event,t.trigger))}),le=V(()=>({swipeDirection:f,snapToSequentialPoints:p,snapPoints:m,activeSnapPoint:P,setActiveSnapPoint:N,frontmostHeight:D,popupHeight:T,hasNestedDrawer:k,nestedSwiping:j,nestedSwipeProgressStore:te,onNestedDrawerPresenceChange:se,onPopupHeightChange:F,onNestedFrontmostHeightChange:oe,onNestedSwipingChange:I,onNestedSwipeProgressChange:ce,notifyParentFrontmostHeight:S,notifyParentSwipingChange:C,notifyParentSwipeProgressChange:x,notifyParentHasNestedDrawer:w}),[P,D,k,j,te,w,x,C,S,se,oe,ce,I,F,T,N,m,p,f]),ue=typeof t==`function`?e=>$(v,{children:[tx||=$(ax,{}),t(e)]}):$(v,{children:[nx||=$(ax,{}),t]});return $(xb.Provider,{value:le,children:$(ex,{open:n,defaultOpen:r,onOpenChange:L,onOpenChangeComplete:a,disablePointerDismissal:o,modal:s,actionsRef:c,handle:l,triggerId:u,defaultTriggerId:d,children:ue})})}function ix(){let e=0,t=new Set;return{getSnapshot:()=>e,set(n){let r=Number.isFinite(n)?n:0;r!==e&&(e=r,t.forEach(e=>{e()}))},subscribe(e){return t.add(e),()=>{t.delete(e)}}}}function ax(){let e=Ug(),t=Gg(!0),n=_h(!1),r=n.store.useState(`open`),i=n.store.useState(`nestedOpenDialogCount`),a=n.store.useState(`popupElement`),o=i===0;return z(()=>{if(!(!t||e==null))return()=>{t.removeDrawer(e)}},[e,t]),z(()=>{e!=null&&t?.setDrawerOpen(e,r)},[e,r,t]),z(()=>{if(!r||!o||!i_)return;let e=hg(a).CloseWatcher;if(!e)return;function t(e){n.store.select(`open`)&&n.store.setOpen(!1,zg(Lg,e))}let i=new e;return i.addEventListener(`close`,t),()=>{i.removeEventListener(`close`,t),i.destroy()}},[n.store,o,r,a]),null}var ox=null;function sx(){ox||(ox=document.createElement(`style`),ox.textContent=`
